...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - responsable"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - responsable"); } ?></TITLE>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_responsable/form_responsable_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_responsable_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_responsable_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['recarga'];
}
?>
...
<?php
 include_once("form_responsable_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="form_responsable_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_responsable_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_responsable_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - responsable"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - responsable"; } ?></span></td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { ?>
<span id="id_read_on_cedula" class="sc-ui-readonly-cedula css_cedula_line" style="<?php echo $sStyleReadLab_cedula; ?>"><?php echo $this->form_encode_input($this->cedula); ?></span><span id="id_read_off_cedula" style="white-space: nowrap;<?php echo $sStyleReadInp_cedula; ?>">
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['funciones']))
    {
        $this->nm_new_label['funciones'] = "Funciones";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $sStyleHidden_funciones = '';
   if (isset($this->nmgp_cmp_hidden['funciones']) && $this->nmgp_cmp_hidden['funciones'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['funciones']);
       $sStyleHidden_funciones = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_funciones = 'display: none;';
   $sStyleReadInp_funciones = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['funciones']) && $this->nmgp_cmp_readonly['funciones'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['funciones']);
       $sStyleReadLab_funciones = '';
       $sStyleReadInp_funciones = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['funciones']) && $this->nmgp_cmp_hidden['funciones'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="funciones" value="<?php echo $this->form_encode_input($funciones) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_funciones_line" id="hidden_field_data_funciones" style="<?php echo $sStyleHidden_funciones; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_funciones_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_funciones_label"><span id="id_label_funciones"><?php echo $this->nm_new_label['funciones']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["funciones"]) &&  $this->nmgp_cmp_readonly["funciones"] == "on") { 

 ?>
<input type="hidden" name="funciones" value="<?php echo $this->form_encode_input($funciones) . "\">" . $funciones . ""; ?>
<?php } else { ?>
<span id="id_read_on_funciones" class="sc-ui-readonly-funciones css_funciones_line" style="<?php echo $sStyleReadLab_funciones; ?>"><?php echo $this->form_encode_input($this->funciones); ?></span><span id="id_read_off_funciones" style="white-space: nowrap;<?php echo $sStyleReadInp_funciones; ?>">
 <input class="sc-js-input scFormObjectOdd css_funciones_obj" style="" id="id_sc_field_funciones" type=text name="funciones" value="<?php echo $this->form_encode_input($funciones) ?>"
 size=45 maxlength=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_funciones_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_funciones_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['verificacion']))
    {
        $this->nm_new_label['verificacion'] = "Verificacion";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $sStyleHidden_verificacion = '';
   if (isset($this->nmgp_cmp_hidden['verificacion']) && $this->nmgp_cmp_hidden['verificacion'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['verificacion']);
       $sStyleHidden_verificacion = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_verificacion = 'display: none;';
   $sStyleReadInp_verificacion = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['verificacion']) && $this->nmgp_cmp_readonly['verificacion'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['verificacion']);
       $sStyleReadLab_verificacion = '';
       $sStyleReadInp_verificacion = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['verificacion']) && $this->nmgp_cmp_hidden['verificacion'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="verificacion" value="<?php echo $this->form_encode_input($verificacion) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_verificacion_line" id="hidden_field_data_verificacion" style="<?php echo $sStyleHidden_verificacion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_verificacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_verificacion_label"><span id="id_label_verificacion"><?php echo $this->nm_new_label['verificacion']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["verificacion"]) &&  $this->nmgp_cmp_readonly["verificacion"] == "on") { 

 ?>
<input type="hidden" name="verificacion" value="<?php echo $this->form_encode_input($verificacion) . "\">" . $verificacion . ""; ?>
<?php } else { ?>
<span id="id_read_on_verificacion" class="sc-ui-readonly-verificacion css_verificacion_line" style="<?php echo $sStyleReadLab_verificacion; ?>"><?php echo $this->form_encode_input($this->verificacion); ?></span><span id="id_read_off_verificacion" style="white-space: nowrap;<?php echo $sStyleReadInp_verificacion; ?>">
 <input class="sc-js-input scFormObjectOdd css_verificacion_obj" style="" id="id_sc_field_verificacion" type=text name="verificacion" value="<?php echo $this->form_encode_input($verificacion) ?>"
 size=45 maxlength=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_verificacion_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_verificacion_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["grupo"]) &&  $this->nmgp_cmp_readonly["grupo"] == "on") { 
 ...
 ?>
<input type="hidden" name="grupo" value="<?php echo $this->form_encode_input($grupo) . "\">" . $grupo . ""; ?>
<?php } else { ?>
<span id="id_read_on_grupo" class="sc-ui-readonly-grupo css_grupo_line" style="<?php echo $sStyleReadLab_grupo; ?>"><?php echo $this->form_encode_input($this->grupo); ?></span><span id="id_read_off_grupo" style="white-space: nowrap;<?php echo $sStyleReadInp_grupo; ?>">
 <input class="sc-js-input scFormObjectOdd css_grupo_obj" style="" id="id_sc_field_grupo" type=text name="grupo" value="<?php echo $this->form_encode_input($grupo) ?>"
 size=45 maxlength=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['total'] + 1)?>);</script><?php }} ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsable_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_responsable_mob");
 parent.scAjaxDetailHeight("form_responsable_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
