  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_subcategoria" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nombre_
  function do_ajax_form_subcategoria_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subcategoria_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_subcategoria_validate_nombre__cb);
  } // do_ajax_form_subcategoria_validate_nombre_

  function do_ajax_form_subcategoria_validate_nombre__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subcategoria_validate_nombre__cb

  // ---------- Validate categoria_
  function do_ajax_form_subcategoria_validate_categoria_(iNumLinha)
  {
    var nomeCampo_categoria_ = "categoria_" + iNumLinha;
    var var_categoria_ = scAjaxGetFieldSelect(nomeCampo_categoria_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subcategoria_validate_categoria_(var_categoria_, iNumLinha, var_script_case_init, do_ajax_form_subcategoria_validate_categoria__cb);
  } // do_ajax_form_subcategoria_validate_categoria_

  function do_ajax_form_subcategoria_validate_categoria__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "categoria_" + iLineNumber;
    }
    else
    {
      sFieldValid = "categoria_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "categoria_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "categoria_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_subcategoria_validate_categoria__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_subcategoria_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_subcategoria_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_subcategoria_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_subcategoria_add_new_line_cb);
  } // do_ajax_form_subcategoria_add_new_line

  function do_ajax_form_subcategoria_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_subcategoria_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_subcategoria_backup_line(iNumLinha)
  {
    var var_nombre_ = scAjaxGetFieldText("nombre_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_subcategoria_backup_line(var_nombre_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_subcategoria_backup_line_cb);
  } // do_ajax_form_subcategoria_backup_line

  function do_ajax_form_subcategoria_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_subcategoria_backup_line_cb

  function do_ajax_form_subcategoria_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_subcategoria_cancel_insert

  function do_ajax_form_subcategoria_cancel_update(iSeqVert)
  {
    do_ajax_form_subcategoria_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_subcategoria_cancel_update

  function do_ajax_form_subcategoria_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_subcategoria_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_subcategoria_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_subcategoria_table_refresh(var_nombre_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_subcategoria_table_refresh_cb);
  } //  do_ajax_form_subcategoria_table_refresh

  function do_ajax_form_subcategoria_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_subcategoria_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_subcategoria_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_subcategoria_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_nombre_ = scAjaxGetFieldText("nombre_" + iNumLinha);
    var var_categoria_ = scAjaxGetFieldSelect("categoria_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_subcategoria_submit_form(var_nombre_, var_categoria_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_subcategoria_submit_form_cb);
  } // do_ajax_form_subcategoria_submit_form

  function do_ajax_form_subcategoria_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("categoria_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_subcategoria_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_subcategoria_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_subcategoria_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("categoria_" + iNavForm);
    }
    var var_nombre_ = document.F2.nombre_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_subcategoria_navigate_form(var_nombre_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_subcategoria_navigate_form_cb);
  } // do_ajax_form_subcategoria_navigate_form

  function do_ajax_form_subcategoria_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_subcategoria_navigate_form_cb
  function sc_hide_form_subcategoria_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_subcategoria_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "categoria_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["categoria_" + iNumLinha] = {"label": "Categoria<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_mult["categoria_"][iNumLinha] = "categoria_" + iNumLinha;
    ajax_field_id["nombre_" + iNumLinha] = new Array("hidden_field_label_nombre_", "hidden_field_data_nombre_" + iNumLinha);
    ajax_field_id["categoria_" + iNumLinha] = new Array("hidden_field_label_categoria_", "hidden_field_data_categoria_" + iNumLinha);
    ajax_error_count["nombre_" + iNumLinha] = "off";
    ajax_error_count["categoria_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["nombre_" + iNumLinha] = "on";
    ajax_read_only["categoria_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["nombre_" + iNumLinha] = "on";
    ajax_read_only["categoria_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["categoria_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["categoria_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["categoria_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["categoria_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["categoria_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["categoria_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['categoria_'])) ? $this->nmgp_cmp_readonly['categoria_'] : 'off';
?>
    scAjaxFieldRead("categoria_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("nombre_" + iSeq, "on");
    scAjaxFieldRead("categoria_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["categoria_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_categoria_" + iRow))
        document.getElementById("hidden_field_data_categoria_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["categoria_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["nombre_" + iRow] = "off";
        ajax_error_count["categoria_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_categoria_" + iRow))
        document.getElementById("hidden_field_data_categoria_" + iRow).className = sCssLine;
    }
  }
