...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_pregunta"  <?php echo $str_hide_pregunta?>><INPUT  type="text" id="SC_pregunta" name="pregunta" value="<?php echo NM_encode_input($pregunta) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
