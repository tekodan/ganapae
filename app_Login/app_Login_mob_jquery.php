...
function scEventControl_init(iSeqRow) {
  scEventControl_data["imagen_logo" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": ""};
...
function scEventControl_active(iSeqRow) {
  if (scEventControl_data["imagen_logo" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["imagen_logo" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_imagen_logo' + iSeqRow).bind('blur', function() { sc_app_Login_imagen_logo_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_app_Login_imagen_logo_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_app_Login_imagen_logo_onblur(oThis, iSeqRow) {
  do_ajax_app_Login_mob_validate_imagen_logo();
  scCssBlur(oThis);
}

function sc_app_Login_imagen_logo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
