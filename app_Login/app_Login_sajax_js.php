...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_app_Login_validate_imagen_logo()
  {
    var nomeCampo_imagen_logo = "imagen_logo";
    var var_imagen_logo = scAjaxGetFieldText(nomeCampo_imagen_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_validate_imagen_logo(var_imagen_logo, var_script_case_init, do_ajax_app_Login_validate_imagen_logo_cb);
  } // do_ajax_app_Login_validate_imagen_logo

  function do_ajax_app_Login_validate_imagen_logo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_validate_imagen_logo_cb
  ...
  function do_ajax_app_Login_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_Login_submit_form(var_imagen_logo, var_login, var_pswd, var_links, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_Login_submit_form_cb);
