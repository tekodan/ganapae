...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'alert'); 
      } 
      else 
      { 
...
//
    ...
    {
        if ('ajax_app_Login_validate_imagen_logo' == $_POST['rs'])
        {
    ...
    else
    {
        ...
        if (isset($_POST["auth_typ"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['auth_typ']);
        }
        ...
        if (isset($_POST["user_id"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['user_id']);
        }
        ...
        if (isset($_POST["user_photo"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['user_photo']);
        }
        ...
        if (isset($_POST["facebook_photo"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['facebook_photo']);
        }
        ...
        if (isset($_POST["user_name"])) 
        {
            ...
            nm_limpa_str_app_Login($_SESSION['user_name']);
        }
    ...
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_app_Login_validate_imagen_logo");
...
//
    ...
    function ajax_app_Login_validate_imagen_logo($imagen_logo, $script_case_init)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
        $inicial_app_Login->contr_app_Login->NM_ajax_opcao         = 'validate_imagen_logo';
    ...
    function ajax_app_Login_submit_form($imagen_logo, $login, $pswd, $links, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_app_Login;
        //register_shutdown_function("app_Login_pack_ajax_response");
        $inicial_app_Login->contr_app_Login->NM_ajax_flag          = true;
