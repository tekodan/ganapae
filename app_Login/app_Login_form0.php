...
<?php
$str_iframe_body = 'margin-top: 60px;';
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;"><?php
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['imagen_logo']))
           {
               $this->nmgp_cmp_readonly['imagen_logo'] = 'on';
           }
?>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['imagen_logo']))
    {
        $this->nm_new_label['imagen_logo'] = "";
    }
?>
<?php
   ...
   $sStyleHidden_imagen_logo = '';
   if (isset($this->nmgp_cmp_hidden['imagen_logo']) && $this->nmgp_cmp_hidden['imagen_logo'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['imagen_logo']);
       $sStyleHidden_imagen_logo = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_imagen_logo = 'display: none;';
   $sStyleReadInp_imagen_logo = '';
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["imagen_logo"]) &&  $this->nmgp_cmp_readonly["imagen_logo"] == "on"))
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['imagen_logo']);
       $sStyleReadLab_imagen_logo = '';
       $sStyleReadInp_imagen_logo = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['imagen_logo']) && $this->nmgp_cmp_hidden['imagen_logo'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="imagen_logo" value="<?php echo $this->form_encode_input($imagen_logo) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_imagen_logo_line" id="hidden_field_data_imagen_logo" style="<?php echo $sStyleHidden_imagen_logo; ?>"> <?php
...
?>
<span id="id_imghtml_imagen_logo"><?php echo $imagen_logo; ?>
</span>
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["imagen_logo"]) &&  $this->nmgp_cmp_readonly["imagen_logo"] == "on")) { 

 ?>
<input type="hidden" name="imagen_logo" value="<?php echo $this->form_encode_input($imagen_logo) . "\"><span id=\"id_ajax_label_imagen_logo\">" . $imagen_logo . "</span>"; ?>
<?php } else { ?>
<span id="id_read_on_imagen_logo" class="sc-ui-readonly-imagen_logo css_imagen_logo_line" style="<?php echo $sStyleReadLab_imagen_logo; ?>"><?php echo $this->form_encode_input($this->imagen_logo); ?></span><span id="id_read_off_imagen_logo" style="white-space: nowrap;<?php echo $sStyleReadInp_imagen_logo; ?>"></span><?php } ?>
 </TD>
   <?php }?>
...
<?php $sStyleHidden_imagen_logo_dumb = ('' == $sStyleHidden_imagen_logo) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_imagen_logo_dumb" style="<?php echo $sStyleHidden_imagen_logo_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<br>
 ...
 <a href="javascript:nm_menu_link_links('app_retrieve_pswd')" class="scFormLinkOdd">Olvido la clave?</a>
<br>
<?php  } ?>
 </TD>
   <?php }?>
