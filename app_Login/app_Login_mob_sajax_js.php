...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate imagen_logo
  function do_ajax_app_Login_mob_validate_imagen_logo()
  {
    var nomeCampo_imagen_logo = "imagen_logo";
    var var_imagen_logo = scAjaxGetFieldText(nomeCampo_imagen_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_Login_mob_validate_imagen_logo(var_imagen_logo, var_script_case_init, do_ajax_app_Login_mob_validate_imagen_logo_cb);
  } // do_ajax_app_Login_mob_validate_imagen_logo

  function do_ajax_app_Login_mob_validate_imagen_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "imagen_logo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_Login_mob_validate_imagen_logo_cb
  ...
  function do_ajax_app_Login_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_Login_mob_submit_form(var_imagen_logo, var_login, var_pswd, var_links, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_Login_mob_submit_form_cb);
...
?>
  ...
  var ajax_error_list = {
    "imagen_logo": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "login": {"label": "Usuario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pswd": {"label": "Clave", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "imagen_logo": new Array(),
    "login": new Array(),
    "pswd": new Array(),
    "links": new Array()
  };
  ajax_field_mult["imagen_logo"][1] = "imagen_logo";
  ajax_field_mult["login"][1] = "login";
  ajax_field_mult["pswd"][1] = "pswd";
  ajax_field_mult["links"][1] = "links";

  var ajax_field_id = {
    "imagen_logo": new Array("hidden_field_label_imagen_logo", "hidden_field_data_imagen_logo"),
