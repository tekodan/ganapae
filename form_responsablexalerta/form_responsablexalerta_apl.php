<?php
//
class form_responsablexalerta_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_responsablexalerta']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_responsablexalerta']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_responsablexalerta']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_responsablexalerta']['total']))
          {
              $_SESSION['sc_session'][$script_case_init]['form_accionxalertxresponsable']['reg_start'] = "";
              unset($_SESSION['sc_session'][$script_case_init]['form_accionxalertxresponsable']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_responsablexalerta']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_responsablexalerta']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_responsablexalerta']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_responsablexalerta']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_responsablexalerta']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_responsablexalerta']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_responsablexalerta']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_responsablexalerta']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_responsablexalerta']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_responsablexalerta']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_responsablexalerta_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_responsablexalerta']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_responsablexalerta']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_responsablexalerta'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_responsablexalerta']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_responsablexalerta']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_responsablexalerta') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_responsablexalerta']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - responsablexalerta";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_responsablexalerta")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_responsablexalerta']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_responsablexalerta'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_responsablexalerta']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_responsablexalerta", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_responsablexalerta/form_responsablexalerta_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_responsablexalerta_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_responsablexalerta_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_responsablexalerta_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_responsablexalerta/form_responsablexalerta_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_responsablexalerta_erro.class.php"); 
      }
      $this->Erro      = new form_responsablexalerta_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['opcao']))
         { 
             if ($this->id != "" || $this->idalerta != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_responsablexalerta']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_accionxalertxresponsable') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_accionxalertxresponsable') . "/form_accionxalertxresponsable_apl.php");
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['sc_redir_atualiz'] == "ok")
          {
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_responsablexalerta']) || !is_array($this->NM_ajax_info['errList']['geral_form_responsablexalerta']))
              {
                  $this->NM_ajax_info['errList']['geral_form_responsablexalerta'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_responsablexalerta'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if ('' == $filtro || 'id' == $filtro)
...
//---
      ...
      if (empty($Campos_Crit) && empty($Campos_Falta) && empty($this->Campos_Mens_erro))
      {
          ...
          {
              $_SESSION['scriptcase']['form_responsablexalerta']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_responsablexalerta']['contr_erro'] = 'off'; 
    ...
    {
        global $teste_validade;
               if (!empty($this->cedula) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['Lookup_cedula']) && !in_array($this->cedula, $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['Lookup_cedula']))
               {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['php_cmp_required']['idalerta']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['php_cmp_required']['idalerta'] == "on")) 
      { 
          if ($this->idalerta == "")  
          { 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_responsablexalerta_pack_protect_string($this->nmgp_dados_form['id']);
              $this->NM_ajax_info['fldList']['idalerta']['keyVal'] = form_responsablexalerta_pack_protect_string($this->nmgp_dados_form['idalerta']);
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['total'] < 0)
              {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['Lookup_cedula']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['Lookup_cedula'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['Lookup_cedula']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['Lookup_cedula'] = array(); 
}
...
ORDER BY name";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_responsablexalerta_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_responsablexalerta_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['Lookup_cedula'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cedula']['valList'][$i] = form_responsablexalerta_pack_protect_string($v);
          }
...
$aLookup[] = array(form_responsablexalerta_pack_protect_string('Responsable') => form_responsablexalerta_pack_protect_string("Responsable"));
$aLookup[] = array(form_responsablexalerta_pack_protect_string('Supervisor') => form_responsablexalerta_pack_protect_string("Supervisor"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['Lookup_tipo'][] = 'Responsable';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['Lookup_tipo'][] = 'Supervisor';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"tipo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['tipo']['valList'][$i] = form_responsablexalerta_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_accion($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->accion = $this->accion_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['parms'] = "id?#?$this->id?@?idalerta?#?$this->idalerta?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['where_filter_form'];
      }
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_responsablexalerta = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['total'] = $qt_geral_reg_form_responsablexalerta;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id) && !empty($this->idalerta))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_responsablexalerta = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start'] > $qt_geral_reg_form_responsablexalerta)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start'] = $qt_geral_reg_form_responsablexalerta; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_responsablexalerta) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start']) ;  
              } 
          } 
          ...
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start'] < $qt_geral_reg_form_responsablexalerta;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("form_responsablexalerta_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['empty_filter']);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_responsablexalerta_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_responsablexalerta_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_responsablexalerta_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['masterValue'] as $cmp_master => $val_master)
{
?>
