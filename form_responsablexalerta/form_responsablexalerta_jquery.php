...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fecha_hora' + iSeqRow).bind('blur', function() { sc_form_responsablexalerta_fecha_hora_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_responsablexalerta_fecha_hora_onfocus(this, iSeqRow) });
...
function sc_form_responsablexalerta_fecha_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_responsablexalerta_validate_fecha();
  scCssBlur(oThis);
}
...
function sc_form_responsablexalerta_fecha_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
