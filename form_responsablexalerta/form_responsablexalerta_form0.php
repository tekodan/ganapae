...
<?php
include_once("form_responsablexalerta_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_responsablexalerta_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['recarga'];
}
?>
...
<?php
 include_once("form_responsablexalerta_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_responsablexalerta'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_responsablexalerta'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cedula_line" id="hidden_field_data_cedula" style="<?php echo $sStyleHidden_cedula; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cedula_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idalerta_label" id="hidden_field_label_idalerta" style="<?php echo $sStyleHidden_idalerta; ?>"><span id="id_label_idalerta"><?php echo $this->nm_new_label['idalerta']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['php_cmp_required']['idalerta']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['php_cmp_required']['idalerta'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_idalerta_line" id="hidden_field_data_idalerta" style="<?php echo $sStyleHidden_idalerta; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idalerta_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_origen_label" id="hidden_field_label_origen" style="<?php echo $sStyleHidden_origen; ?>"><span id="id_label_origen"><?php echo $this->nm_new_label['origen']; ?></span></TD>
    <TD class="scFormDataOdd css_origen_line" id="hidden_field_data_origen" style="<?php echo $sStyleHidden_origen; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_origen_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_destino_label" id="hidden_field_label_destino" style="<?php echo $sStyleHidden_destino; ?>"><span id="id_label_destino"><?php echo $this->nm_new_label['destino']; ?></span></TD>
    <TD class="scFormDataOdd css_destino_line" id="hidden_field_data_destino" style="<?php echo $sStyleHidden_destino; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_destino_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['Lookup_tipo'][] = 'Responsable'; ?>
 <option value="Supervisor" <?php  if ($this->tipo == "Supervisor") { echo " selected" ;} ?>>Supervisor</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['Lookup_tipo'][] = 'Supervisor'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_accion_label" id="hidden_field_label_accion" style="<?php echo $sStyleHidden_accion; ?>"><span id="id_label_accion"><?php echo $this->nm_new_label['accion']; ?></span></TD>
    <TD class="scFormDataOdd css_accion_line" id="hidden_field_data_accion" style="<?php echo $sStyleHidden_accion; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_accion_line" style="vertical-align: top;padding: 0px">
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_responsablexalerta_empty.htm' : $this->Ini->link_form_accionxalertxresponsable_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y');
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalerta']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_responsablexalerta");
 parent.scAjaxDetailHeight("form_responsablexalerta", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
