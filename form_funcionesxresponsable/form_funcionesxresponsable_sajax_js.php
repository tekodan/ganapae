  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_funcionesxresponsable" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id
  function do_ajax_form_funcionesxresponsable_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionesxresponsable_validate_id(var_id, var_script_case_init, do_ajax_form_funcionesxresponsable_validate_id_cb);
  } // do_ajax_form_funcionesxresponsable_validate_id

  function do_ajax_form_funcionesxresponsable_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionesxresponsable_validate_id_cb

  // ---------- Validate cedula
  function do_ajax_form_funcionesxresponsable_validate_cedula()
  {
    var nomeCampo_cedula = "cedula";
    var var_cedula = scAjaxGetFieldText(nomeCampo_cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionesxresponsable_validate_cedula(var_cedula, var_script_case_init, do_ajax_form_funcionesxresponsable_validate_cedula_cb);
  } // do_ajax_form_funcionesxresponsable_validate_cedula

  function do_ajax_form_funcionesxresponsable_validate_cedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cedula";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionesxresponsable_validate_cedula_cb

  // ---------- Validate funciones
  function do_ajax_form_funcionesxresponsable_validate_funciones()
  {
    var nomeCampo_funciones = "funciones";
    var var_funciones = scAjaxGetFieldText(nomeCampo_funciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionesxresponsable_validate_funciones(var_funciones, var_script_case_init, do_ajax_form_funcionesxresponsable_validate_funciones_cb);
  } // do_ajax_form_funcionesxresponsable_validate_funciones

  function do_ajax_form_funcionesxresponsable_validate_funciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionesxresponsable_validate_funciones_cb
  // ---------- Form
  function do_ajax_form_funcionesxresponsable_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_funcionesxresponsable_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_funcionesxresponsable_submit_form(var_id, var_cedula, var_funciones, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_funcionesxresponsable_submit_form_cb);
  } // do_ajax_form_funcionesxresponsable_submit_form

  function do_ajax_form_funcionesxresponsable_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_funcionesxresponsable_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_funcionesxresponsable_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_funcionesxresponsable_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_funcionesxresponsable_navigate_form_cb);
  } // do_ajax_form_funcionesxresponsable_navigate_form

  function do_ajax_form_funcionesxresponsable_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_funcionesxresponsable_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_funcionesxresponsable_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_funcionesxresponsable_navigate_form_cb
  function sc_hide_form_funcionesxresponsable_form()
  {
