...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_control_mob_submit_form()
  {
    ...
    var var_sc_field_0_ul_name = scAjaxSpecCharProtect(document.F1.sc_field_0_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_sc_field_0_ul_type = document.F1.sc_field_0_ul_type.value;
    var var_sc_field_0_salva = scAjaxSpecCharProtect(document.F1.sc_field_0_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_sc_field_0_limpa = document.F1.sc_field_0_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_control_mob_submit_form(var_sc_field_0, var_sc_field_0_ul_name, var_sc_field_0_ul_type, var_sc_field_0_salva, var_sc_field_0_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_mob_submit_form_cb);
  ...
  function do_ajax_control_mob_submit_form_cb(sResp)
  {
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.sc_field_0_limpa && document.F1.sc_field_0_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldDocument("sc_field_0", oImgTemp, "", "");
      }
      else if (document.getElementById("id_ajax_doc_sc_field_0") && "" != document.getElementById("id_ajax_doc_sc_field_0").innerHTML)
      {
        document.getElementById("id_ajax_doc_sc_field_0").style.display = "";
      }
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
...
?>
  ...
  var ajax_error_list = {
    "sc_field_0": {"label": "Cargar Excel", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
