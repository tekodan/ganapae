...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['control_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'alert'); 
      } 
      else 
      { 
...
//
    ...
    $sc_conv_var = array();
    $sc_conv_var['cargar excel'] = "sc_field_0";
    if (!empty($_FILES))
    {
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']))
    {
        ...
        {
            $sc_field_0 = NM_utf8_urldecode($_POST['rsargs'][0]);
            $sc_field_0_ul_name = NM_utf8_urldecode($_POST['rsargs'][1]);
            $sc_field_0_ul_type = NM_utf8_urldecode($_POST['rsargs'][2]);
            $sc_field_0_salva = NM_utf8_urldecode($_POST['rsargs'][3]);
            $sc_field_0_limpa = NM_utf8_urldecode($_POST['rsargs'][4]);
...
//
    ...
    function ajax_control_mob_submit_form($sc_field_0, $sc_field_0_ul_name, $sc_field_0_ul_type, $sc_field_0_salva, $sc_field_0_limpa, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_control_mob;
        //register_shutdown_function("control_mob_pack_ajax_response");
        $inicial_control_mob->contr_control_mob->NM_ajax_flag          = true;
        ...
        $inicial_control_mob->contr_control_mob->NM_ajax_info['param'] = array(
                  'sc_field_0' => NM_utf8_urldecode($sc_field_0),
                  'sc_field_0_ul_name' => NM_utf8_urldecode($sc_field_0_ul_name),
                  'sc_field_0_ul_type' => NM_utf8_urldecode($sc_field_0_ul_type),
                  'sc_field_0_salva' => NM_utf8_urldecode($sc_field_0_salva),
                  'sc_field_0_limpa' => NM_utf8_urldecode($sc_field_0_limpa),
