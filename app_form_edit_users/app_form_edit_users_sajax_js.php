...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate cedula
  function do_ajax_app_form_edit_users_validate_cedula()
  {
    var nomeCampo_cedula = "cedula";
    var var_cedula = scAjaxGetFieldText(nomeCampo_cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_app_form_edit_users_validate_cedula(var_cedula, var_script_case_init, do_ajax_app_form_edit_users_validate_cedula_cb);
  } // do_ajax_app_form_edit_users_validate_cedula

  function do_ajax_app_form_edit_users_validate_cedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cedula";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_app_form_edit_users_validate_cedula_cb
  // ---------- Form
  function do_ajax_app_form_edit_users_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_form_edit_users_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_active, var_groups, var_cedula, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_form_edit_users_submit_form_cb);
