...
$_SESSION['scriptcase']['app_form_edit_users_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET cedula = '$this->cedula', name = '$this->name', email = '$this->email', active = '$this->active'";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET cedula = '$this->cedula', name = '$this->name', email = '$this->email', active = '$this->active'";  
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET cedula = '$this->cedula', name = '$this->name', email = '$this->email', active = '$this->active'";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET cedula = '$this->cedula', name = '$this->name', email = '$this->email', active = '$this->active'";  
          ...
          $this->priv_admin = $this->priv_admin_before_qstr;
              ...
              $this->nmgp_refresh_fields = array_diff(array('login', 'pswd', 'confirm_pswd', 'name', 'email', 'active', 'groups', 'cedula'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (cedula, login, pswd, name, email, active, activation_code, priv_admin) VALUES ('$this->cedula', '$this->login', '$this->pswd', '$this->name', '$this->email', '$this->active', '$this->activation_code', '$this->priv_admin')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "cedula, login, pswd, name, email, active, activation_code, priv_admin) VALUES (" . $NM_seq_auto . "'$this->cedula', '$this->login', '$this->pswd', '$this->name', '$this->email', '$this->active', '$this->activation_code', '$this->priv_admin')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "cedula, login, pswd, name, email, active, activation_code, priv_admin) VALUES (" . $NM_seq_auto . "'$this->cedula', '$this->login', '$this->pswd', '$this->name', '$this->email', '$this->active', '$this->activation_code', '$this->priv_admin')"; 
...
//---------- 
      ...
      { 
          ...
          { 
              $nmgp_select = "SELECT cedula, login, pswd, name, email, active, activation_code, priv_admin from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT cedula, login, pswd, name, email, active, activation_code, priv_admin from " . $this->Ini->nm_tabela ; 
          ...
          { 
              ...
              $this->activation_code = $rs->fields[6] ; 
              $this->nmgp_dados_select['activation_code'] = $this->activation_code;
              $this->priv_admin = $rs->fields[7] ; 
