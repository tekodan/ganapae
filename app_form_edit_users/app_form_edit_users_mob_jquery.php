...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_cedula' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_cedula_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_app_form_edit_users_cedula_onfocus(this, iSeqRow) });
...
function sc_app_form_edit_users_cedula_onblur(oThis, iSeqRow) {
  do_ajax_app_form_edit_users_mob_validate_cedula();
  scCssBlur(oThis);
}

function sc_app_form_edit_users_cedula_onfocus(oThis, iSeqRow) {
