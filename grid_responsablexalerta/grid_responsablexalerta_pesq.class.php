...
class grid_responsablexalerta_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_responsablexalerta_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_responsablexalerta_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_responsablexalerta_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_responsablexalerta_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idalerta')
      {
          $idalerta = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idalerta($idalerta);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_idalerta($idalerta)
   {
      $idalerta = substr($this->Db->qstr($idalerta), 1, -1);
            $idalerta_look = substr($this->Db->qstr($idalerta), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct idalerta from " . $this->Ini->nm_tabela . " where  idalerta like '%" . $idalerta . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "responsablexalerta.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - responsablexalerta</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_responsablexalerta/grid_responsablexalerta_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_responsablexalerta_ajax_search.js"></script>
 <script type="text/javascript" src="grid_responsablexalerta_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_idalerta_cond#NMF#' + search_get_sel_txt('SC_idalerta_cond') + '@NMF@';
  str_out += 'SC_idalerta#NMF#' + search_get_text('SC_idalerta') + '@NMF@';
  str_out += 'id_ac_idalerta#NMF#' + search_get_text('id_ac_idalerta') + '@NMF@';
   ...
   $("#id_ac_idalerta").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_idalerta",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_idalerta").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_idalerta").val( $(this).val() );
       }
     }
   });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - responsablexalerta</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $idalerta_cond, $idalerta, $idalerta_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['fecha']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['fecha_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['id']; 
          $id_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['id_input_2']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['id_cond']; 
          $cedula = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['cedula']; 
          $cedula_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['cedula_cond']; 
          $idalerta = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['idalerta']; 
          $idalerta_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['idalerta_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($idalerta_cond) || empty($idalerta_cond))
      {
         $idalerta_cond = "qp";
      }
      ...
      $str_hide_idalerta = (in_array($idalerta_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (isset($idalerta) && !empty($idalerta))
      {
         $tmp_pos = strpos($idalerta, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idalerta = substr($idalerta, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_responsablexalerta_help.txt"))
   {
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_cedula" name="cedula_autocomp" size="45" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['idalerta'])) ? $this->New_label['idalerta'] : "Idalerta"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idalerta_cond" name="idalerta_cond" onChange="nm_campos_between(document.getElementById('id_vis_idalerta'), this, 'idalerta')">
       <OPTION value="qp" <?php if ("qp" == $idalerta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $idalerta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idalerta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $idalerta_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idalerta" <?php echo $str_hide_idalerta?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['idalerta'])) ? $this->New_label['idalerta'] : "Idalerta";
 $nmgp_tab_label .= "idalerta?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $idalerta_look = substr($this->Db->qstr($idalerta), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct idalerta from " . $this->Ini->nm_tabela . " where idalerta = '$idalerta_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$idalerta]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idalerta];
      }
      else
      {
          $sAutocompValue = $idalerta;
      }
?>
<INPUT  type="text" id="SC_idalerta" name="idalerta" value="<?php echo NM_encode_input($idalerta) ?>" size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_idalerta" name="idalerta_autocomp" size="45" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_responsablexalerta']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_responsablexalerta']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_idalerta'), document.F1.idalerta_cond, 'idalerta');
   document.F1.idalerta.value = "";
   document.F1.idalerta_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "alert/grid_responsablexalerta";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_responsablexalerta/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_idalerta_cond'] = 'cond';
      $tp_fields['SC_idalerta'] = 'text_aut';
      $tp_fields['id_ac_idalerta'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   function trata_campos()
   {
      global $fecha_cond, $fecha, $fecha_autocomp,
             $id_cond, $id, $id_input_2, $id_autocomp,
             $cedula_cond, $cedula, $cedula_autocomp,
             $idalerta_cond, $idalerta, $idalerta_autocomp, $nmgp_tab_label;
      ...
      if (!empty($idalerta_autocomp) && empty($idalerta))
      {
          $idalerta = $idalerta_autocomp;
      }
      ...
      $idalerta_cond_salva = $idalerta_cond; 
      if (!isset($idalerta_input_2) || $idalerta_input_2 == "")
      {
          $idalerta_input_2 = $idalerta;
      }
      if ($id_cond != "in")
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['fecha'] = $fecha; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['id_input_2'] = $id_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['cedula'] = $cedula; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['cedula_cond'] = $cedula_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['idalerta'] = $idalerta; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['idalerta_cond'] = $idalerta_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']['NM_operador'] = $this->NM_operador; 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idalerta'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['idalerta'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['idalerta'] = $idalerta;
      }
      ...
      //----- $idalerta
      $this->Date_part = false;
      if (isset($idalerta) || $idalerta_cond == "nu" || $idalerta_cond == "nn" || $idalerta_cond == "ep" || $idalerta_cond == "ne")
      {
         $this->monta_condicao("idalerta", $idalerta_cond, $idalerta, "", "idalerta");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsablexalerta']['where_pesq_ant'] = $this->comando . $this->comando_fim;
