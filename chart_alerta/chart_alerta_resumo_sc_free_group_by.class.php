...
class chart_alerta_resumo
{
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_escalar;
   var $array_total_fecha;
   var $array_total_lugar;
   var $array_total_municipio;
   var $array_total_subcategoria;
   var $array_total_categoria;
   var $array_total_terminado;
   ...
   //---- 
   function chart_alerta_resumo($tipo = "")
   {
      ...
      $this->array_total_escalar      = array();
      $this->array_total_fecha        = array();
      $this->array_total_lugar        = array();
      $this->array_total_municipio    = array();
      $this->array_total_subcategoria = array();
      $this->array_total_categoria    = array();
      $this->array_total_terminado    = array();
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_alerta']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['chart_alerta']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['chart_alerta']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['where_pesq_filtro'];
         if (isset($_POST['reload_comb_chart']) && 'Y' == $_POST['reload_comb_chart'])
         {
             ob_start();
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['chart_combination_type'] = $_POST['fc_chart_type'];
         }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_x_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_y_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_order'] = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['comb_field_display_type']  = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['chart_display_values']     = array();

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['chart_combination_type']        = 'pie3d';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['chart_combination_order_rule']  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['chart_combination_order_field'] = 'label';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_y_axys'][0] = 0;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_y_axys'][1] = 1;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_y_axys'][2] = 2;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_y_axys'][3] = 3;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_y_axys'][4] = 4;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_y_axys'][5] = 5;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_y_axys'][6] = 6;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_cmp']["escalar"] = 'escalar';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_cmp']["fecha"] = 'fecha';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_cmp']["lugar"] = 'lugar';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_cmp']["municipio"] = 'municipio';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_cmp']["subcategoria"] = 'subcategoria';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_cmp']["categoria"] = 'categoria';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_cmp']["terminado"] = 'terminado';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_sql']["escalar"] = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_sql']["fecha"] = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_sql']["lugar"] = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_sql']["municipio"] = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_sql']["subcategoria"] = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_sql']["categoria"] = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_sql']["terminado"] = 'asc';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['comb_field_display_type'][1] = 'line';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['chart_display_values'][1] = false;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_display'][1]['display'] = true;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_order'][] = 1;
       }

      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['ajax_nav'])
      {
          $_SESSION['scriptcase']['saida_var'] = false; 
      }
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("chart_alerta", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['contr_total_geral'] == "OK")
      {
          $this->array_total_escalar = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_total']['escalar'];
          $this->array_total_fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_total']['fecha'];
          $this->array_total_lugar = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_total']['lugar'];
          $this->array_total_municipio = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_total']['municipio'];
          $this->array_total_subcategoria = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_total']['subcategoria'];
          $this->array_total_categoria = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_total']['categoria'];
          $this->array_total_terminado = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_total']['terminado'];
      }
      else
      {
          $this->array_total_escalar = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_total']['escalar'] = $this->array_total_escalar;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_total']['fecha'] = $this->array_total_fecha;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_total']['lugar'] = $this->array_total_lugar;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_total']['municipio'] = $this->array_total_municipio;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_total']['subcategoria'] = $this->array_total_subcategoria;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_total']['categoria'] = $this->array_total_categoria;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_total']['terminado'] = $this->array_total_terminado;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $prep_field = array();
       $prep_field['escalar'] = "Escalar";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['labels'][''] = "Escalar"; 
       $prep_field['fecha'] = "Fecha";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['labels'][''] = "Fecha"; 
       $prep_field['lugar'] = "Lugar";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['labels'][''] = "Lugar"; 
       $prep_field['municipio'] = "Municipio";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['labels'][''] = "Municipio"; 
       $prep_field['subcategoria'] = "Subcategoria";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['labels'][''] = "Subcategoria"; 
       $prep_field['categoria'] = "Categoria";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['labels'][''] = "Categoria"; 
       $prep_field['terminado'] = "Terminado";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['labels'][''] = "Terminado"; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_control'] = array(
               'NM_Count' => array(
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['municipio']['alin'] = "''";
       $Arr_parms['municipio']['link'] = "N";
       $Arr_parms['lugar']['alin'] = "''";
       $Arr_parms['lugar']['link'] = "N";
       $Arr_parms['fecha']['alin'] = "''";
       $Arr_parms['fecha']['link'] = "N";
       $Arr_parms['escalar']['alin'] = "''";
       $Arr_parms['escalar']['link'] = "N";
       $Arr_parms['terminado']['alin'] = "''";
       $Arr_parms['terminado']['link'] = "N";
       $Arr_parms['categoria']['alin'] = "''";
       $Arr_parms['categoria']['link'] = "N";
       $Arr_parms['subcategoria']['alin'] = "''";
       $Arr_parms['subcategoria']['link'] = "N";
       $Arr_parms['escalar']['fill'] = "true";
       $Arr_parms['escalar']['order'] = "label";
       $Arr_parms['fecha']['fill'] = "true";
       $Arr_parms['fecha']['order'] = "value";
       $Arr_parms['lugar']['fill'] = "true";
       $Arr_parms['lugar']['order'] = "label";
       $Arr_parms['municipio']['fill'] = "true";
       $Arr_parms['municipio']['order'] = "label";
       $Arr_parms['subcategoria']['fill'] = "true";
       $Arr_parms['subcategoria']['order'] = "label";
       $Arr_parms['categoria']['fill'] = "true";
       $Arr_parms['categoria']['order'] = "label";
       $Arr_parms['terminado']['fill'] = "true";
       $Arr_parms['terminado']['order'] = "value";
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['municipio'] = array(0 => 'municipio', 1 => '@aspass@');
       $prep_links_fl['lugar'] = array(0 => 'lugar', 1 => '@aspass@');
       $prep_links_fl['fecha'] = array(0 => 'fecha', 1 => '@aspass@');
       $prep_links_fl['escalar'] = array(0 => 'escalar', 1 => '@aspass@');
       $prep_links_fl['terminado'] = array(0 => 'terminado', 1 => '');
       $prep_links_fl['categoria'] = array(0 => 'categoria', 1 => '@aspass@');
       $prep_links_fl['subcategoria'] = array(0 => 'subcategoria', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_tabular'];
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '0' => array(
               ...
               'show_sub' => false,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Lugar"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           ),
           ...
           '0' => array(
               ...
               'show_sub' => false,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Fecha"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           ),
           ...
           '0' => array(
               ...
               'show_sub' => false,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Escalar"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           ),
           ...
           '0' => array(
               ...
               'show_sub' => false,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Terminado"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           ),
           ...
           '0' => array(
               ...
               'show_sub' => false,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Categoria"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           ),
           ...
           '0' => array(
               ...
               'show_sub' => false,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Subcategoria"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           ),
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['summarizing_fields_order'] as $i_summ_order)
       {
                   ...
                   foreach ($this->sc_comb_quick_index[$i_index_summ] as $i_index_comb_groupby)
                   {
                       ...
                       if (!isset($a_chart_combinations[$s_comb_index]))
                       {
                           $a_chart_combinations[$s_comb_index] = array(
                               ...
                               'label_x'     => '',
                               'label_y'     => '',
                               'xml_pholder' => sizeof($this->comp_y_axys) > $i_index_group + 1 ? 'sc_chart_alerta_' . session_id() . '_C_' . ($i_index_group + 1) . '_' . $s_index_comb . ('' == $s_index_comb ? '' : '_') . '__SC_PLACEHOLDER__.xml' : '',
                               'xml'         => 'sc_chart_alerta_' . session_id() . '_C_' . $i_index_group . '_' . $s_index_comb . '.xml',
                           );
                       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['comb_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_chart_alerta_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_chart_alerta_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['embutida'])
                   {
   ...
   function resumo_init()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_alerta']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_alerta']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_alerta']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_alerta']) . "_";
               } 
           }
       }
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chart_alerta_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['opcao'] = "print";
      ...
      $this->total   = new chart_alerta_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_sc_free_group_by("res", $this->array_total_escalar, $this->array_total_fecha, $this->array_total_lugar, $this->array_total_municipio, $this->array_total_subcategoria, $this->array_total_categoria, $this->array_total_terminado);
      ksort($this->array_total_escalar);
      ksort($this->array_total_fecha);
      ksort($this->array_total_lugar);
      ksort($this->array_total_municipio);
      ksort($this->array_total_subcategoria);
      ksort($this->array_total_categoria);
      ksort($this->array_total_terminado);
      $this->total->quebra_geral();
   }
...
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
      ...
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_chart_titl'] . " - alerta</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_alerta_ajax.js\"></script>\r\n");
      include_once($this->Ini->Apl_grafico);
      $sFusionChartModule = chart_alerta_grafico::getChartModule();
      if ('' == $sFusionChartModule)
      {
          $sFusionChartModule = chart_alerta_grafico::getChartModule('Bar');
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_alerta_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chart_alerta_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_alerta_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chart_alerta/chart_alerta_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['embutida'])
      {
   ...
   $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsort_on", "scShowSort('#chart_sort_on_top')", "scShowSort('#chart_sort_on_top')", "chart_sort_on_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_alerta/chart_alerta_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
         ...
         if (is_file("chart_alerta_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("chart_alerta_help.txt"); 
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_alerta_config_pivot.php?nome_apl=chart_alerta&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "chart_alerta/chart_alerta_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['chart_alerta_iframe_params'] = array(
      ...
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "chart_alerta/chart_alerta_iframe.php?scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_alerta_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chart_alerta/chart_alerta_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_charts']);
      ...
      if (!isset($this->progress_fp) || !$this->progress_fp)
      {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
   $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chart_alerta_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      $nm_cab_filtro   = ""; 
      $nm_cab_filtrobr = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['campos_busca']))
      { 
        $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['campos_busca'];
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
            $Busca_temp = NM_conv_charset($Busca_temp, $_SESSION['scriptcase']['charset'], "UTF-8");
        }
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['cond_pesq'], 0, $trab_pos);
      ...
      $nm_saida->saida("    	<tr>\r\n");
      $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>" . $this->Ini->Nm_lang['lang_othr_chart_titl'] . " - alerta</span></td>\r\n");
   ...
   //---- 
   function adiciona_registro($quebra_escalar, $quebra_fecha, $quebra_lugar, $quebra_municipio, $quebra_subcategoria, $quebra_categoria, $quebra_terminado, $quebra_escalar_orig, $quebra_fecha_orig, $quebra_lugar_orig, $quebra_municipio_orig, $quebra_subcategoria_orig, $quebra_categoria_orig, $quebra_terminado_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT latitud, longitud, estado, idalerta, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, str_replace (convert(char(10),fecha,102), '.', '-') + ' ' + convert(char(8),fecha,20), escalar, terminado, categoria, subcategoria from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT latitud, longitud, estado, idalerta, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, fecha, escalar, terminado, categoria, subcategoria from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     { 
         $nmgp_select = "SELECT latitud, longitud, estado, idalerta, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, convert(char(23),fecha,121), escalar, terminado, categoria, subcategoria from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT latitud, longitud, estado, idalerta, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, fecha, escalar, terminado, categoria, subcategoria from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['where_pesq']; 
     $temp = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_alerta']['SC_Gb_Free_sql'] as $cmp_gb => $ord)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->latitud = $rs_res->fields[0] ;  
            $this->longitud = $rs_res->fields[1] ;  
            $this->estado = $rs_res->fields[2] ;  
            $this->idalerta = $rs_res->fields[3] ;  
            $this->geo = $rs_res->fields[4] ;  
            $this->correo = $rs_res->fields[5] ;  
            $this->nombre = $rs_res->fields[6] ;  
            $this->celular = $rs_res->fields[7] ;  
            $this->direccion = $rs_res->fields[8] ;  
            $this->alerta = $rs_res->fields[9] ;  
            $this->rutavideo = $rs_res->fields[10] ;  
            $this->rutaaudio = $rs_res->fields[11] ;  
            $this->rutaimagen = $rs_res->fields[12] ;  
            $this->canal = $rs_res->fields[13] ;  
            $this->radicado = $rs_res->fields[14] ;  
            $this->origenalerta = $rs_res->fields[15] ;  
            $this->departamento = $rs_res->fields[16] ;  
            $this->municipio = $rs_res->fields[17] ;  
            $this->lugar = $rs_res->fields[18] ;  
            $this->fecha = $rs_res->fields[19] ;  
            $this->escalar = $rs_res->fields[20] ;  
            $this->terminado = $rs_res->fields[21] ;  
            $this->categoria = $rs_res->fields[22] ;  
            $this->subcategoria = $rs_res->fields[23] ;  
            $this->escalar_orig = $this->escalar;
            $this->fecha_orig = $this->fecha;
            $this->lugar_orig = $this->lugar;
            $this->municipio_orig = $this->municipio;
            $this->subcategoria_orig = $this->subcategoria;
            $this->categoria_orig = $this->categoria;
            $this->terminado_orig = $this->terminado;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->escalar, $this->fecha, $this->lugar, $this->municipio, $this->subcategoria, $this->categoria, $this->terminado, $this->escalar_orig,  $this->fecha_orig,  $this->lugar_orig,  $this->municipio_orig,  $this->subcategoria_orig,  $this->categoria_orig,  $this->terminado_orig);
            }
   }
//
