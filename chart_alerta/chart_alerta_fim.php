...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["alert_____chart_alerta"]))
   {
      unset($_SESSION['session_sec_aplicacao']["alert_____chart_alerta"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_alerta']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_alerta']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_alerta']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_alerta']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_alerta']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_alerta']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_alerta']['embutida_filho'] as $ind => $sc_init)
          {
