  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_descripciontagxcanal" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate tag
  function do_ajax_form_descripciontagxcanal_validate_tag()
  {
    var nomeCampo_tag = "tag";
    var var_tag = scAjaxGetFieldText(nomeCampo_tag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_descripciontagxcanal_validate_tag(var_tag, var_script_case_init, do_ajax_form_descripciontagxcanal_validate_tag_cb);
  } // do_ajax_form_descripciontagxcanal_validate_tag

  function do_ajax_form_descripciontagxcanal_validate_tag_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_descripciontagxcanal_validate_tag_cb

  // ---------- Validate nombre
  function do_ajax_form_descripciontagxcanal_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_descripciontagxcanal_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_descripciontagxcanal_validate_nombre_cb);
  } // do_ajax_form_descripciontagxcanal_validate_nombre

  function do_ajax_form_descripciontagxcanal_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_descripciontagxcanal_validate_nombre_cb

  // ---------- Validate canal
  function do_ajax_form_descripciontagxcanal_validate_canal()
  {
    var nomeCampo_canal = "canal";
    var var_canal = scAjaxGetFieldText(nomeCampo_canal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_descripciontagxcanal_validate_canal(var_canal, var_script_case_init, do_ajax_form_descripciontagxcanal_validate_canal_cb);
  } // do_ajax_form_descripciontagxcanal_validate_canal

  function do_ajax_form_descripciontagxcanal_validate_canal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "canal";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_descripciontagxcanal_validate_canal_cb
  // ---------- Form
  function do_ajax_form_descripciontagxcanal_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_descripciontagxcanal_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_descripciontagxcanal_submit_form(var_tag, var_nombre, var_canal, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_descripciontagxcanal_submit_form_cb);
  } // do_ajax_form_descripciontagxcanal_submit_form

  function do_ajax_form_descripciontagxcanal_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_descripciontagxcanal_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_descripciontagxcanal_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_descripciontagxcanal_navigate_form(var_tag, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_descripciontagxcanal_navigate_form_cb);
  } // do_ajax_form_descripciontagxcanal_navigate_form

  function do_ajax_form_descripciontagxcanal_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_descripciontagxcanal_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_descripciontagxcanal_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_descripciontagxcanal_navigate_form_cb
  function sc_hide_form_descripciontagxcanal_form()
  {
