<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idresponsablealerta_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idresponsablealerta_']); ?>">
<input type="hidden" name="idalerta_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idalerta_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_responsablexalertaline"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_responsablexalertaline']['where_detal']))
  {
?>  
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_responsablexalertaline_submit_form(y, z); 
} 
<?php
}
?>
