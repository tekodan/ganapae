...
class grid_descripciontagxcanal_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_descripciontagxcanal_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_descripciontagxcanal.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_descripciontagxcanal']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_descripciontagxcanal']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_descripciontagxcanal']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_descripciontagxcanal']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_descripciontagxcanal";
   ...
   function NM_export_tag()
   {
         ...
         $this->xml_registro .= " tag =\"" . $this->trata_dados($this->tag) . "\"";
   }
   //----- nombre
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->canal))
         {
             $this->canal = sc_convert_encoding($this->canal, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " canal =\"" . $this->trata_dados($this->canal) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_descripciontagxcanal']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_descripciontagxcanal']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - descripciontagxcanal :: XML</TITLE>
