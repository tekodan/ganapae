<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_responsable_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_responsable_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["cedula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_responsable']['labels']["cedula"])) ? $_SESSION['sc_session'][$sc_init]['grid_responsable']['labels']["cedula"] : "Cedula";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "nombre";
   $tab_converte["nombre"]   = "nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_responsable']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_responsable']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['cargo'] = "on";
   $tab_def_campos['cargo'] = "cargo";
   $tab_converte["cargo"]   = "cargo";
   $tab_labels["cargo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_responsable']['labels']["cargo"])) ? $_SESSION['sc_session'][$sc_init]['grid_responsable']['labels']["cargo"] : "Cargo";
   $tab_ger_campos['funciones'] = "on";
   $tab_def_campos['funciones'] = "funciones";
   $tab_converte["funciones"]   = "funciones";
   $tab_labels["funciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_responsable']['labels']["funciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_responsable']['labels']["funciones"] : "Funciones";
   $tab_ger_campos['correo'] = "on";
   $tab_def_campos['correo'] = "correo";
   $tab_converte["correo"]   = "correo";
   $tab_labels["correo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_responsable']['labels']["correo"])) ? $_SESSION['sc_session'][$sc_init]['grid_responsable']['labels']["correo"] : "Correo";
   $tab_ger_campos['celular'] = "on";
   $tab_def_campos['celular'] = "celular";
   $tab_converte["celular"]   = "celular";
   $tab_labels["celular"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_responsable']['labels']["celular"])) ? $_SESSION['sc_session'][$sc_init]['grid_responsable']['labels']["celular"] : "Celular";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_responsable']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_responsable']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_responsable']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_responsable']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_responsable']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_responsable']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_responsable']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_responsable']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_responsable']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - responsable</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_responsable_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_responsable']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_responsable']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
