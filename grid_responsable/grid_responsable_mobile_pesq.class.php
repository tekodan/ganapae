...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_funciones"  <?php echo $str_hide_funciones?>><?php
      $funciones_look = substr($this->Db->qstr($funciones), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_cedula"  <?php echo $str_hide_cedula?>><?php
      $cedula_look = substr($this->Db->qstr($cedula), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_cargo"  <?php echo $str_hide_cargo?>><?php
      $cargo_look = substr($this->Db->qstr($cargo), 1, -1); 
      $nmgp_def_dados = array(); 
