...
class grid_responsable_pesq
{
    ...
    * @access  public
    */
   function grid_responsable_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_responsable_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_responsable_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_responsable_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_funciones')
      {
          $funciones = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_funciones($funciones);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cedula')
      {
          $cedula = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cedula($cedula);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cargo')
      {
          $cargo = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cargo($cargo);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_funciones($funciones)
   {
      $funciones = substr($this->Db->qstr($funciones), 1, -1);
            $funciones_look = substr($this->Db->qstr($funciones), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct funciones from " . $this->Ini->nm_tabela . " where  funciones like '%" . $funciones . "%'"; 
   ...
   function lookup_ajax_cedula($cedula)
   {
      $cedula = substr($this->Db->qstr($cedula), 1, -1);
            $cedula_look = substr($this->Db->qstr($cedula), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cedula from " . $this->Ini->nm_tabela . " where  cedula like '%" . $cedula . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_cargo($cargo)
   {
      $cargo = substr($this->Db->qstr($cargo), 1, -1);
            $cargo_look = substr($this->Db->qstr($cargo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cargo from " . $this->Ini->nm_tabela . " where  cargo like '%" . $cargo . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - responsable</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_responsable/grid_responsable_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_responsable_ajax_search.js"></script>
 <script type="text/javascript" src="grid_responsable_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_funciones_cond#NMF#' + search_get_sel_txt('SC_funciones_cond') + '@NMF@';
  str_out += 'SC_funciones#NMF#' + search_get_text('SC_funciones') + '@NMF@';
  str_out += 'id_ac_funciones#NMF#' + search_get_text('id_ac_funciones') + '@NMF@';
  str_out += 'SC_cedula_cond#NMF#' + search_get_sel_txt('SC_cedula_cond') + '@NMF@';
  str_out += 'SC_cedula#NMF#' + search_get_text('SC_cedula') + '@NMF@';
  str_out += 'id_ac_cedula#NMF#' + search_get_text('id_ac_cedula') + '@NMF@';
  ...
  str_out += 'SC_cargo_cond#NMF#' + search_get_sel_txt('SC_cargo_cond') + '@NMF@';
  str_out += 'SC_cargo#NMF#' + search_get_text('SC_cargo') + '@NMF@';
  str_out += 'id_ac_cargo#NMF#' + search_get_text('id_ac_cargo') + '@NMF@';
   ...
   $("#id_ac_cedula").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_cedula",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_cedula").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_cedula").val( $(this).val() );
       }
     }
   });
   ...
   $("#id_ac_cargo").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_cargo",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_cargo").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_cargo").val( $(this).val() );
       }
     }
   });
   $("#id_ac_funciones").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_funciones",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_funciones").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_funciones").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - responsable</span></td>
...
<?php
   ...
   {
      global 
             $funciones_cond, $funciones, $funciones_autocomp,
             $cedula_cond, $cedula, $cedula_autocomp,
             $nombre_cond, $nombre, $nombre_autocomp,
             $cargo_cond, $cargo, $cargo_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $funciones = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['funciones']; 
          $funciones_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['funciones_cond']; 
          $cedula = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['cedula']; 
          $cedula_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['cedula_cond']; 
          $nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['nombre']; 
          $nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['nombre_cond']; 
          $cargo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['cargo']; 
          $cargo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['cargo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['NM_operador']; 
      } 
      if (!isset($funciones_cond) || empty($funciones_cond))
      {
         $funciones_cond = "qp";
      }
      ...
      if (!isset($cargo_cond) || empty($cargo_cond))
      {
         $cargo_cond = "qp";
      }
      ...
      $str_hide_funciones = (in_array($funciones_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_cargo = (in_array($cargo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($funciones, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $funciones = substr($funciones, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($cargo, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $cargo = substr($cargo, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_responsable_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['funciones'])) ? $this->New_label['funciones'] : "Funciones"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_funciones_cond" name="funciones_cond" onChange="nm_campos_between(document.getElementById('id_vis_funciones'), this, 'funciones')">
       <OPTION value="qp" <?php if ("qp" == $funciones_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $funciones_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $funciones_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $funciones_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_funciones" <?php echo $str_hide_funciones?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['funciones'])) ? $this->New_label['funciones'] : "Funciones";
 $nmgp_tab_label .= "funciones?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $funciones_look = substr($this->Db->qstr($funciones), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct funciones from " . $this->Ini->nm_tabela . " where funciones = '$funciones_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$funciones]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$funciones];
      }
      else
      {
          $sAutocompValue = $funciones;
      }
?>
<INPUT  type="text" id="SC_funciones" name="funciones" value="<?php echo NM_encode_input($funciones) ?>" size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_funciones" name="funciones_autocomp" size="45" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['cedula'])) ? $this->New_label['cedula'] : "Cedula"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cedula_cond" name="cedula_cond" onChange="nm_campos_between(document.getElementById('id_vis_cedula'), this, 'cedula')">
       <OPTION value="qp" <?php if ("qp" == $cedula_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cedula_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cedula_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cedula_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      $cedula_look = substr($this->Db->qstr($cedula), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cedula from " . $this->Ini->nm_tabela . " where cedula = '$cedula_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$cedula]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$cedula];
      }
      else
      {
          $sAutocompValue = $cedula;
      }
?>
<INPUT  type="text" id="SC_cedula" name="cedula" value="<?php echo NM_encode_input($cedula) ?>" size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cedula" name="cedula_autocomp" size="30" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nombre" name="nombre_autocomp" size="45" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['cargo'])) ? $this->New_label['cargo'] : "Cargo"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cargo_cond" name="cargo_cond" onChange="nm_campos_between(document.getElementById('id_vis_cargo'), this, 'cargo')">
       <OPTION value="qp" <?php if ("qp" == $cargo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cargo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cargo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cargo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cargo" <?php echo $str_hide_cargo?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['cargo'])) ? $this->New_label['cargo'] : "Cargo";
 $nmgp_tab_label .= "cargo?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $cargo_look = substr($this->Db->qstr($cargo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cargo from " . $this->Ini->nm_tabela . " where cargo = '$cargo_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$cargo]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$cargo];
      }
      else
      {
          $sAutocompValue = $cargo;
      }
?>
<INPUT  type="text" id="SC_cargo" name="cargo" value="<?php echo NM_encode_input($cargo) ?>" size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cargo" name="cargo_autocomp" size="45" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_responsable']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_responsable']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_funciones'), document.F1.funciones_cond, 'funciones');
   document.F1.funciones.value = "";
   document.F1.funciones_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_cedula'), document.F1.cedula_cond, 'cedula');
   document.F1.cedula.value = "";
   document.F1.cedula_autocomp.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_cargo'), document.F1.cargo_cond, 'cargo');
   document.F1.cargo.value = "";
   document.F1.cargo_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "alert/grid_responsable";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_funciones_cond'] = 'cond';
      $tp_fields['SC_funciones'] = 'text_aut';
      $tp_fields['id_ac_funciones'] = 'text_aut';
      $tp_fields['SC_cedula_cond'] = 'cond';
      $tp_fields['SC_cedula'] = 'text_aut';
      $tp_fields['id_ac_cedula'] = 'text_aut';
      $tp_fields['SC_nombre_cond'] = 'cond';
      $tp_fields['SC_nombre'] = 'text_aut';
      $tp_fields['id_ac_nombre'] = 'text_aut';
      $tp_fields['SC_cargo_cond'] = 'cond';
      $tp_fields['SC_cargo'] = 'text_aut';
      $tp_fields['id_ac_cargo'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $funciones_cond, $funciones, $funciones_autocomp,
             $cedula_cond, $cedula, $cedula_autocomp,
             $nombre_cond, $nombre, $nombre_autocomp,
             $cargo_cond, $cargo, $cargo_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($funciones_autocomp) && empty($funciones))
      {
          $funciones = $funciones_autocomp;
      }
      if (!empty($cedula_autocomp) && empty($cedula))
      {
          $cedula = $cedula_autocomp;
      }
      if (!empty($nombre_autocomp) && empty($nombre))
      {
          $nombre = $nombre_autocomp;
      }
      if (!empty($cargo_autocomp) && empty($cargo))
      {
          $cargo = $cargo_autocomp;
      }
      $funciones_cond_salva = $funciones_cond; 
      if (!isset($funciones_input_2) || $funciones_input_2 == "")
      {
          $funciones_input_2 = $funciones;
      }
      ...
      $cargo_cond_salva = $cargo_cond; 
      if (!isset($cargo_input_2) || $cargo_input_2 == "")
      {
          $cargo_input_2 = $cargo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['funciones'] = $funciones; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['funciones_cond'] = $funciones_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['cedula'] = $cedula; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['cedula_cond'] = $cedula_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['nombre'] = $nombre; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['nombre_cond'] = $nombre_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['cargo'] = $cargo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['cargo_cond'] = $cargo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['funciones'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['funciones'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['funciones'] = $funciones;
      }
      $cedula_look = substr($this->Db->qstr($cedula), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct cedula from " . $this->Ini->nm_tabela . " where cedula = '$cedula_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cedula'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['cedula'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cedula'] = $cedula;
      }
      $nombre_look = substr($this->Db->qstr($nombre), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombre from " . $this->Ini->nm_tabela . " where nombre = '$nombre_look'"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['cargo'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cargo'] = $cargo;
      }

      //----- $funciones
      $this->Date_part = false;
      if (isset($funciones) || $funciones_cond == "nu" || $funciones_cond == "nn" || $funciones_cond == "ep" || $funciones_cond == "ne")
      {
         $this->monta_condicao("funciones", $funciones_cond, $funciones, "", "funciones");
      }
      ...
      //----- $cargo
      $this->Date_part = false;
      if (isset($cargo) || $cargo_cond == "nu" || $cargo_cond == "nn" || $cargo_cond == "ep" || $cargo_cond == "ne")
      {
         $this->monta_condicao("cargo", $cargo_cond, $cargo, "", "cargo");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_responsable']['where_pesq_ant'] = $this->comando . $this->comando_fim;
