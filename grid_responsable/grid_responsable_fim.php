...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["alert_____grid_responsable"]))
   {
      unset($_SESSION['session_sec_aplicacao']["alert_____grid_responsable"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_responsable'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_responsable']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_responsable']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_responsable']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_responsable']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_responsable']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_responsable']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_responsable']['embutida_filho'] as $ind => $sc_init)
          {
