...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "verificacion";$Nm_numeric[] = "idresponsablealerta";$Nm_numeric[] = "id";$Nm_numeric[] = "verificacion";$Nm_numeric[] = "idresponsablealerta";
...
<HTML>
<HEAD>
 <TITLE> - accionxalertxresponsable</TITLE>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_fecha"  <?php echo $str_hide_fecha?>><?php
      $fecha_look = substr($this->Db->qstr($fecha), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_accion"  <?php echo $str_hide_accion?>><?php
      $accion_look = substr($this->Db->qstr($accion), 1, -1); 
      $nmgp_def_dados = array(); 
