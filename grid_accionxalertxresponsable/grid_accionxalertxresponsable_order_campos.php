<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_accionxalertxresponsable_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_accionxalertxresponsable_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["id"]   = "id";
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['labels']["id"] : "Id";
   $tab_ger_campos['accion'] = "on";
   $tab_def_campos['accion'] = "accion";
   $tab_converte["accion"]   = "accion";
   $tab_labels["accion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['labels']["accion"])) ? $_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['labels']["accion"] : "Accion";
   $tab_ger_campos['cedula'] = "on";
   $tab_def_campos['cedula'] = "cedula";
   $tab_converte["cedula"]   = "cedula";
   $tab_labels["cedula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['labels']["cedula"])) ? $_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['labels']["cedula"] : "Cedula";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_converte["fecha"]   = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['verificacion'] = "on";
   $tab_def_campos['verificacion'] = "verificacion";
   $tab_converte["verificacion"]   = "verificacion";
   $tab_labels["verificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['labels']["verificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['labels']["verificacion"] : "Verificacion";
   $tab_ger_campos['idresponsablealerta'] = "on";
   $tab_def_campos['idresponsablealerta'] = "idresponsablealerta";
   $tab_converte["idresponsablealerta"]   = "idresponsablealerta";
   $tab_labels["idresponsablealerta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['labels']["idresponsablealerta"])) ? $_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['labels']["idresponsablealerta"] : "Idresponsablealerta";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - accionxalertxresponsable</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_accionxalertxresponsable_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_accionxalertxresponsable']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
