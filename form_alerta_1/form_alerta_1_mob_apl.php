...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_alerta_1_mob']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['form_alerta_1']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_alerta_1']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_alerta_1_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_alerta_1_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_alerta_1_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_alerta_1_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_alerta_1_mob']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_alerta_1_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_alerta_1_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_alerta_1_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_alerta_1_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_alerta_1_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_alerta_1_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_alerta_1_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_alerta_1_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_alerta_1_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_alerta_1_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_alerta_1_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_alerta_1_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_alerta_1_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_alerta_1_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_alerta_1_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - alerta";
      ...
      $_SESSION['scriptcase']['error_icon']['form_alerta_1_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_alerta_1_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_1_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_alerta_1_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_alerta_1/form_alerta_1_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_alerta_1_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_alerta_1_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_alerta_1_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_alerta_1/form_alerta_1_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_alerta_1_mob_erro.class.php"); 
      }
      $this->Erro      = new form_alerta_1_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['opcao']))
         { 
             if ($this->idalerta != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_1_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      if (isset($this->rutavideo)) { $this->nm_limpa_alfa($this->rutavideo); }
      if (isset($this->rutaaudio)) { $this->nm_limpa_alfa($this->rutaaudio); }
      if (isset($this->rutaimagen)) { $this->nm_limpa_alfa($this->rutaimagen); }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- terminado
      $this->field_config['terminado']               = array();
      $this->field_config['terminado']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['terminado']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['terminado']['symbol_dec'] = '';
      $this->field_config['terminado']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['terminado']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
   }
...
//
   ...
   {
       $nm_comando = "SELECT pregunta, pregunta + respuesta FROM baseconocimiento WHERE pregunta + respuesta LIKE '%" . substr($this->Db->qstr($this->motivo), 1, -1) . "%' ORDER BY pregunta, respuesta";
   }
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
   {
       $nm_comando = "SELECT pregunta, concat(pregunta, respuesta) FROM baseconocimiento WHERE concat(pregunta, respuesta) LIKE '%" . substr($this->Db->qstr($this->motivo), 1, -1) . "%' ORDER BY pregunta, respuesta";
   }
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_alerta_1_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_alerta_1_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['recarga'] = $this->nmgp_opcao;
      }
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_alerta_1_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_alerta_1_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_alerta_1_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_alerta_1_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_geo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->geo) > 500) 
          { 
              $Campos_Crit .= "Geo " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 500 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['geo']))
              {
                  $Campos_Erros['geo'] = array();
              }
              $Campos_Erros['geo'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 500 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['geo']) || !is_array($this->NM_ajax_info['errList']['geo']))
              {
                  $this->NM_ajax_info['errList']['geo'] = array();
              }
              $this->NM_ajax_info['errList']['geo'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 500 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_geo
    ...
    function ValidateField_alerta(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->alerta) > 32767) 
          { 
              $Campos_Crit .= "Alerta " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 32767 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['alerta']))
              {
                  $Campos_Erros['alerta'] = array();
              }
              $Campos_Erros['alerta'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 32767 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['alerta'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 32767 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    ...
    function ValidateField_rutavideo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->rutavideo) > 45) 
          { 
              $Campos_Crit .= "Rutavideo " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['rutavideo']))
              {
                  $Campos_Erros['rutavideo'] = array();
              }
              $Campos_Erros['rutavideo'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['rutavideo'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    ...
    function ValidateField_rutaaudio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->rutaaudio) > 45) 
          { 
              $Campos_Crit .= "Rutaaudio " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['rutaaudio']))
              {
                  $Campos_Erros['rutaaudio'] = array();
              }
              $Campos_Erros['rutaaudio'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['rutaaudio'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    ...
    function ValidateField_rutaimagen(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->rutaimagen) > 45) 
          { 
              $Campos_Crit .= "Rutaimagen " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['rutaimagen']))
              {
                  $Campos_Erros['rutaimagen'] = array();
              }
              $Campos_Erros['rutaimagen'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['rutaimagen'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    ...
    function ValidateField_origenalerta(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->origenalerta) > 45) 
          { 
              $Campos_Crit .= "Origenalerta " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['origenalerta']))
              {
                  $Campos_Erros['origenalerta'] = array();
              }
              $Campos_Erros['origenalerta'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['origenalerta']) || !is_array($this->NM_ajax_info['errList']['origenalerta']))
              {
                  $this->NM_ajax_info['errList']['origenalerta'] = array();
              }
              $this->NM_ajax_info['errList']['origenalerta'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    ...
    function ValidateField_municipio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->municipio) > 45) 
          { 
              $Campos_Crit .= "Municipio " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['municipio']))
              {
                  $Campos_Erros['municipio'] = array();
              }
              $Campos_Erros['municipio'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['municipio'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    ...
    function ValidateField_lugar(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->lugar) > 45) 
          { 
              $Campos_Crit .= "Lugar " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['lugar']))
              {
                  $Campos_Erros['lugar'] = array();
              }
              $Campos_Erros['lugar'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['lugar']) || !is_array($this->NM_ajax_info['errList']['lugar']))
              {
                  $this->NM_ajax_info['errList']['lugar'] = array();
              }
              $this->NM_ajax_info['errList']['lugar'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_lugar
    ...
    function ValidateField_escalar(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->escalar) > 2) 
          { 
              $Campos_Crit .= "Escalar " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 2 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['escalar']))
              {
                  $Campos_Erros['escalar'] = array();
              }
              $Campos_Erros['escalar'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 2 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['escalar']) || !is_array($this->NM_ajax_info['errList']['escalar']))
              {
                  $this->NM_ajax_info['errList']['escalar'] = array();
              }
              $this->NM_ajax_info['errList']['escalar'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 2 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    ...
    function ValidateField_motivo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->motivo) > 32767) 
          { 
              ...
              $Campos_Erros['motivo'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 32767 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['motivo'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 32767 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    ...
    function ValidateField_terminado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      nm_limpa_numero($this->terminado, $this->field_config['terminado']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->terminado != '')  
          { 
              $iTestSize = 11;
              if (strlen($this->terminado) > $iTestSize)  
              { 
                  $Campos_Crit .= "Terminado: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['terminado']))
                  {
                      $Campos_Erros['terminado'] = array();
                  }
                  $Campos_Erros['terminado'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['terminado']) || !is_array($this->NM_ajax_info['errList']['terminado']))
                  {
                      $this->NM_ajax_info['errList']['terminado'] = array();
                  }
                  $this->NM_ajax_info['errList']['terminado'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->terminado, 11, 0, -0, 99999999999, "N") == false)  
              { 
                  $Campos_Crit .= "Terminado; " ; 
                  if (!isset($Campos_Erros['terminado']))
                  {
                      $Campos_Erros['terminado'] = array();
                  }
                  $Campos_Erros['terminado'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['terminado']) || !is_array($this->NM_ajax_info['errList']['terminado']))
                  {
                      $this->NM_ajax_info['errList']['terminado'] = array();
                  }
                  $this->NM_ajax_info['errList']['terminado'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      if (!empty($this->terminado) || (!empty($format_fields) && isset($format_fields['terminado'])))
      {
          nmgp_Form_Num_Val($this->terminado, $this->field_config['terminado']['symbol_grp'], $this->field_config['terminado']['symbol_dec'], "0", "S", "", "", "", "-", $this->field_config['terminado']['symbol_fmt']) ; 
      }
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idalerta']['keyVal'] = form_alerta_1_mob_pack_protect_string($this->nmgp_dados_form['idalerta']);
          }
   } // ajax_return_values
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_alerta_1_mob_pack_protect_string(NM_charset_to_utf8($this->motivo))]) ? $aLookup[0][form_alerta_1_mob_pack_protect_string(NM_charset_to_utf8($this->motivo))] : "";
   ...
   function ajax_return_values_terminado($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['form_alerta_1_mob']['contr_erro'] = 'on';
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    $original_idalerta = $this->idalerta;
      ...
      {
          $sc_cmd_dependency = "SELECT COUNT(*) FROM archivos WHERE idalerta = " . $this->idalerta ;
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      {
          $sc_cmd_dependency = "SELECT COUNT(*) FROM archivos WHERE idalerta = " . $this->idalerta ;
      ...
      { 
          ...
          { 
                 ...
                 { 
                      $this->dataset_archivos[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      { 
          $this->dataset_archivos = false;
          $this->dataset_archivos_erro = $this->Db->ErrorMsg();
      } 
;

      if($this->dataset_archivos[0][0] > 0)
      {
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_alerta_1_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
;
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      {
          $sc_cmd_dependency = "SELECT COUNT(*) FROM responsablexalerta WHERE idalerta = " . $this->idalerta ;
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      {
          $sc_cmd_dependency = "SELECT COUNT(*) FROM responsablexalerta WHERE idalerta = " . $this->idalerta ;
      ...
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->dataset_responsablexalerta = array();
      if ($rx = $this->Db->Execute($nm_select)) 
      { 
          $y = 0; 
          $nm_count = $rx->FieldCount();
          ...
          { 
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                      $this->dataset_responsablexalerta[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->dataset_responsablexalerta = false;
          $this->dataset_responsablexalerta_erro = $this->Db->ErrorMsg();
      } 
;

      if($this->dataset_responsablexalerta[0][0] > 0)
      {
...
$_SESSION['scriptcase']['form_alerta_1_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET latitud = '$this->latitud', longitud = '$this->longitud', estado = '$this->estado', geo = '$this->geo', correo = '$this->correo', nombre = '$this->nombre', celular = '$this->celular', direccion = '$this->direccion', alerta = '$this->alerta', rutavideo = '$this->rutavideo', rutaaudio = '$this->rutaaudio', rutaimagen = '$this->rutaimagen', canal = '$this->canal', radicado = '$this->radicado', origenalerta = '$this->origenalerta', departamento = '$this->departamento', municipio = '$this->municipio', lugar = '$this->lugar', fecha = #$this->fecha#, escalar = '$this->escalar', motivo = '$this->motivo', terminado = $this->terminado";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET latitud = '$this->latitud', longitud = '$this->longitud', estado = '$this->estado', geo = '$this->geo', correo = '$this->correo', nombre = '$this->nombre', celular = '$this->celular', direccion = '$this->direccion', alerta = '$this->alerta', rutavideo = '$this->rutavideo', rutaaudio = '$this->rutaaudio', rutaimagen = '$this->rutaimagen', canal = '$this->canal', radicado = '$this->radicado', origenalerta = '$this->origenalerta', departamento = '$this->departamento', municipio = '$this->municipio', lugar = '$this->lugar', fecha = " . $this->Ini->date_delim . $this->fecha . $this->Ini->date_delim1 . ", escalar = '$this->escalar', motivo = '$this->motivo', terminado = $this->terminado";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET latitud = '$this->latitud', longitud = '$this->longitud', estado = '$this->estado', geo = '$this->geo', correo = '$this->correo', nombre = '$this->nombre', celular = '$this->celular', direccion = '$this->direccion', alerta = '$this->alerta', rutavideo = '$this->rutavideo', rutaaudio = '$this->rutaaudio', rutaimagen = '$this->rutaimagen', canal = '$this->canal', radicado = '$this->radicado', origenalerta = '$this->origenalerta', departamento = '$this->departamento', municipio = '$this->municipio', lugar = '$this->lugar', fecha = " . $this->Ini->date_delim . $this->fecha . $this->Ini->date_delim1 . ", escalar = '$this->escalar', motivo = '$this->motivo', terminado = $this->terminado";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET latitud = '$this->latitud', longitud = '$this->longitud', estado = '$this->estado', geo = '$this->geo', correo = '$this->correo', nombre = '$this->nombre', celular = '$this->celular', direccion = '$this->direccion', alerta = '$this->alerta', rutavideo = '$this->rutavideo', rutaaudio = '$this->rutaaudio', rutaimagen = '$this->rutaimagen', canal = '$this->canal', radicado = '$this->radicado', origenalerta = '$this->origenalerta', departamento = '$this->departamento', municipio = '$this->municipio', lugar = '$this->lugar', fecha = EXTEND('$this->fecha', YEAR TO DAY), escalar = '$this->escalar', motivo = '$this->motivo', terminado = $this->terminado";  
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando_oracle = "UPDATE " . $this->Ini->nm_tabela . " SET latitud = '$this->latitud', longitud = '$this->longitud', estado = '$this->estado', geo = '$this->geo', correo = '$this->correo', nombre = '$this->nombre', celular = '$this->celular', direccion = '$this->direccion', alerta = '$this->alerta', rutavideo = '$this->rutavideo', rutaaudio = '$this->rutaaudio', rutaimagen = '$this->rutaimagen', canal = '$this->canal', radicado = '$this->radicado', origenalerta = '$this->origenalerta', departamento = '$this->departamento', municipio = '$this->municipio', lugar = '$this->lugar', fecha = " . $this->Ini->date_delim . $this->fecha . $this->Ini->date_delim1 . ", escalar = '$this->escalar', motivo = '$this->motivo', terminado = $this->terminado";  
          ...
          $this->motivo = $this->motivo_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['db_changed'] = true;
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['rutavideo'])) { $this->rutavideo = $NM_val_form['rutavideo']; }
              elseif (isset($this->rutavideo)) { $this->nm_limpa_alfa($this->rutavideo); }
              if     (isset($NM_val_form) && isset($NM_val_form['rutaaudio'])) { $this->rutaaudio = $NM_val_form['rutaaudio']; }
              elseif (isset($this->rutaaudio)) { $this->nm_limpa_alfa($this->rutaaudio); }
              if     (isset($NM_val_form) && isset($NM_val_form['rutaimagen'])) { $this->rutaimagen = $NM_val_form['rutaimagen']; }
              elseif (isset($this->rutaimagen)) { $this->nm_limpa_alfa($this->rutaimagen); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('latitud', 'longitud', 'estado', 'idalerta', 'geo', 'correo', 'nombre', 'celular', 'direccion', 'alerta', 'rutavideo', 'rutaaudio', 'rutaimagen', 'canal', 'radicado', 'origenalerta', 'departamento', 'municipio', 'lugar', 'fecha', 'escalar', 'motivo', 'terminado'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          { 
              $NM_seq_auto = "NULL, ";
              $NM_cmp_auto = "idalerta, ";
          } 
          $bInsertOk = true;
          $aInsertOk = array(); 
          $bInsertOk = $bInsertOk && empty($aInsertOk);
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (latitud, longitud, estado, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, fecha, escalar, motivo, terminado) VALUES ('$this->latitud', '$this->longitud', '$this->estado', '$this->geo', '$this->correo', '$this->nombre', '$this->celular', '$this->direccion', '$this->alerta', '$this->rutavideo', '$this->rutaaudio', '$this->rutaimagen', '$this->canal', '$this->radicado', '$this->origenalerta', '$this->departamento', '$this->municipio', '$this->lugar', #$this->fecha#, '$this->escalar', '$this->motivo', $this->terminado)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "latitud, longitud, estado, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, fecha, escalar, motivo, terminado) VALUES (" . $NM_seq_auto . "'$this->latitud', '$this->longitud', '$this->estado', '$this->geo', '$this->correo', '$this->nombre', '$this->celular', '$this->direccion', '$this->alerta', '$this->rutavideo', '$this->rutaaudio', '$this->rutaimagen', '$this->canal', '$this->radicado', '$this->origenalerta', '$this->departamento', '$this->municipio', '$this->lugar', " . $this->Ini->date_delim . $this->fecha . $this->Ini->date_delim1 . ", '$this->escalar', '$this->motivo', $this->terminado)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "latitud, longitud, estado, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, fecha, escalar, motivo, terminado) VALUES (" . $NM_seq_auto . "'$this->latitud', '$this->longitud', '$this->estado', '$this->geo', '$this->correo', '$this->nombre', '$this->celular', '$this->direccion', '$this->alerta', '$this->rutavideo', '$this->rutaaudio', '$this->rutaimagen', '$this->canal', '$this->radicado', '$this->origenalerta', '$this->departamento', '$this->municipio', '$this->lugar', " . $this->Ini->date_delim . $this->fecha . $this->Ini->date_delim1 . ", '$this->escalar', '$this->motivo', $this->terminado)"; 
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "latitud, longitud, estado, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, fecha, escalar, motivo, terminado) VALUES (" . $NM_seq_auto . "'$this->latitud', '$this->longitud', '$this->estado', '$this->geo', '$this->correo', '$this->nombre', '$this->celular', '$this->direccion', '$this->alerta', '$this->rutavideo', '$this->rutaaudio', '$this->rutaimagen', '$this->canal', '$this->radicado', '$this->origenalerta', '$this->departamento', '$this->municipio', '$this->lugar', EXTEND('$this->fecha', YEAR TO DAY), '$this->escalar', '$this->motivo', $this->terminado)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "latitud, longitud, estado, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, fecha, escalar, motivo, terminado) VALUES (" . $NM_seq_auto . "'$this->latitud', '$this->longitud', '$this->estado', '$this->geo', '$this->correo', '$this->nombre', '$this->celular', '$this->direccion', '$this->alerta', '$this->rutavideo', '$this->rutaaudio', '$this->rutaimagen', '$this->canal', '$this->radicado', '$this->origenalerta', '$this->departamento', '$this->municipio', '$this->lugar', " . $this->Ini->date_delim . $this->fecha . $this->Ini->date_delim1 . ", '$this->escalar', '$this->motivo', $this->terminado)"; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['parms'] = "idalerta?#?$this->idalerta?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_alerta_1_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['total'] = $qt_geral_reg_form_alerta_1_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idalerta))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_alerta_1_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start'] > $qt_geral_reg_form_alerta_1_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start'] = $qt_geral_reg_form_alerta_1_mob; 
          }
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      if ($this->nmgp_opcao != "novo" && $this->nmgp_opcao != "nada" && $this->nmgp_opcao != "refresh_insert") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
          { 
              $nmgp_select = "SELECT latitud, longitud, estado, idalerta, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, str_replace (convert(char(10),fecha,102), '.', '-') + ' ' + convert(char(8),fecha,20), escalar, motivo, terminado from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT latitud, longitud, estado, idalerta, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, convert(char(23),fecha,121), escalar, motivo, terminado from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $nmgp_select = "SELECT latitud, longitud, estado, idalerta, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, fecha, escalar, motivo, terminado from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $nmgp_select = "SELECT latitud, longitud, estado, idalerta, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, EXTEND(fecha, YEAR TO DAY), escalar, motivo, terminado from " . $this->Ini->nm_tabela ; 
          } 
          else 
          { 
              $nmgp_select = "SELECT latitud, longitud, estado, idalerta, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, fecha, escalar, motivo, terminado from " . $this->Ini->nm_tabela ; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start']) ;  
              } 
          } 
          ...
          { 
              ...
              $this->motivo = $rs->fields[21] ; 
              $this->nmgp_dados_select['motivo'] = $this->motivo;
              $this->terminado = $rs->fields[22] ; 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['reg_start'] < $qt_geral_reg_form_alerta_1_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['dados_select'];
                  $this->latitud = $this->nmgp_dados_select['latitud'];  
                  $this->longitud = $this->nmgp_dados_select['longitud'];  
                  $this->estado = $this->nmgp_dados_select['estado'];  
                  $this->geo = $this->nmgp_dados_select['geo'];  
                  ...
                  $this->alerta = $this->nmgp_dados_select['alerta'];  
                  $this->rutavideo = $this->nmgp_dados_select['rutavideo'];  
                  $this->rutaaudio = $this->nmgp_dados_select['rutaaudio'];  
                  $this->rutaimagen = $this->nmgp_dados_select['rutaimagen'];  
                  $this->canal = $this->nmgp_dados_select['canal'];  
                  $this->radicado = $this->nmgp_dados_select['radicado'];  
                  $this->origenalerta = $this->nmgp_dados_select['origenalerta'];  
                  $this->departamento = $this->nmgp_dados_select['departamento'];  
                  $this->municipio = $this->nmgp_dados_select['municipio'];  
                  $this->lugar = $this->nmgp_dados_select['lugar'];  
                  $this->fecha = $this->nmgp_dados_select['fecha'];  
                  $this->escalar = $this->nmgp_dados_select['escalar'];  
                  $this->motivo = $this->nmgp_dados_select['motivo'];  
                  $this->terminado = $this->nmgp_dados_select['terminado'];  
              }
          }
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['foreign_key']))
          {
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("form_alerta_1_mob_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['empty_filter']);
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "origenalerta", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "escalar", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "terminado", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "latitud", $arg_search, $data_search);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      $qt_geral_reg_form_alerta_1_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['total'] = $qt_geral_reg_form_alerta_1_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_alerta_1_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['SC_sep_date1'];
              }
          }
   ...
   function SC_lookup_motivo($condicao, $campo)
   {
      ...
      { 
          $nm_comando = "SELECT pregunta + respuesta, pregunta FROM baseconocimiento WHERE (pregunta + respuesta LIKE '%$campo%')" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_con_conn_mysql['tpbanco']), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "SELECT concat(pregunta,respuesta), pregunta FROM baseconocimiento WHERE (concat(pregunta,respuesta) LIKE '%$campo%')" ; 
      } 
      ...
      elseif (in_array(strtolower($this->Ini->nm_con_conn_mysql['tpbanco']), $this->Ini->nm_bases_db2))
      { 
          $nm_comando = "SELECT pregunta||respuesta, pregunta FROM baseconocimiento WHERE (pregunta||respuesta LIKE '%$campo%')" ; 
      } 
      else 
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_alerta_1_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_alerta_1_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1_mob']['masterValue']))
{
?>
