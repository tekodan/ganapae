...
<?php
include_once("form_alerta_1_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_alerta_1_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['recarga'];
}
?>
...
<?php
 include_once("form_alerta_1_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_alerta_1'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_alerta_1'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_latitud_label" id="hidden_field_label_latitud" style="<?php echo $sStyleHidden_latitud; ?>"><span id="id_label_latitud"><?php echo $this->nm_new_label['latitud']; ?></span></TD>
    <TD class="scFormDataOdd css_latitud_line" id="hidden_field_data_latitud" style="<?php echo $sStyleHidden_latitud; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_latitud_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_longitud_label" id="hidden_field_label_longitud" style="<?php echo $sStyleHidden_longitud; ?>"><span id="id_label_longitud"><?php echo $this->nm_new_label['longitud']; ?></span></TD>
    <TD class="scFormDataOdd css_longitud_line" id="hidden_field_data_longitud" style="<?php echo $sStyleHidden_longitud; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_longitud_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_geo_label" id="hidden_field_label_geo" style="<?php echo $sStyleHidden_geo; ?>"><span id="id_label_geo"><?php echo $this->nm_new_label['geo']; ?></span></TD>
    <TD class="scFormDataOdd css_geo_line" id="hidden_field_data_geo" style="<?php echo $sStyleHidden_geo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_geo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_alerta_label" id="hidden_field_label_alerta" style="<?php echo $sStyleHidden_alerta; ?>"><span id="id_label_alerta"><?php echo $this->nm_new_label['alerta']; ?></span></TD>
    <TD class="scFormDataOdd css_alerta_line" id="hidden_field_data_alerta" style="<?php echo $sStyleHidden_alerta; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_alerta_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_rutavideo_label" id="hidden_field_label_rutavideo" style="<?php echo $sStyleHidden_rutavideo; ?>"><span id="id_label_rutavideo"><?php echo $this->nm_new_label['rutavideo']; ?></span></TD>
    <TD class="scFormDataOdd css_rutavideo_line" id="hidden_field_data_rutavideo" style="<?php echo $sStyleHidden_rutavideo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rutavideo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_rutaaudio_label" id="hidden_field_label_rutaaudio" style="<?php echo $sStyleHidden_rutaaudio; ?>"><span id="id_label_rutaaudio"><?php echo $this->nm_new_label['rutaaudio']; ?></span></TD>
    <TD class="scFormDataOdd css_rutaaudio_line" id="hidden_field_data_rutaaudio" style="<?php echo $sStyleHidden_rutaaudio; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rutaaudio_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_rutaimagen_label" id="hidden_field_label_rutaimagen" style="<?php echo $sStyleHidden_rutaimagen; ?>"><span id="id_label_rutaimagen"><?php echo $this->nm_new_label['rutaimagen']; ?></span></TD>
    <TD class="scFormDataOdd css_rutaimagen_line" id="hidden_field_data_rutaimagen" style="<?php echo $sStyleHidden_rutaimagen; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rutaimagen_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_canal_label" id="hidden_field_label_canal" style="<?php echo $sStyleHidden_canal; ?>"><span id="id_label_canal"><?php echo $this->nm_new_label['canal']; ?></span></TD>
    <TD class="scFormDataOdd css_canal_line" id="hidden_field_data_canal" style="<?php echo $sStyleHidden_canal; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_canal_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_radicado_label" id="hidden_field_label_radicado" style="<?php echo $sStyleHidden_radicado; ?>"><span id="id_label_radicado"><?php echo $this->nm_new_label['radicado']; ?></span></TD>
    <TD class="scFormDataOdd css_radicado_line" id="hidden_field_data_radicado" style="<?php echo $sStyleHidden_radicado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_radicado_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_origenalerta_label" id="hidden_field_label_origenalerta" style="<?php echo $sStyleHidden_origenalerta; ?>"><span id="id_label_origenalerta"><?php echo $this->nm_new_label['origenalerta']; ?></span></TD>
    <TD class="scFormDataOdd css_origenalerta_line" id="hidden_field_data_origenalerta" style="<?php echo $sStyleHidden_origenalerta; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_origenalerta_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_escalar_line" id="hidden_field_data_escalar" style="<?php echo $sStyleHidden_escalar; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_escalar_line" style="vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_1']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_alerta_1");
 parent.scAjaxDetailHeight("form_alerta_1", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
