...
<?php
include_once("form_alerta_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_alerta_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['recarga'];
}
?>
...
<?php
 include_once("form_alerta_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_alerta'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_alerta'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes != "novo") && ($opcao_botoes != "novo")) {
        $sCondStyle = ($this->nmgp_botoes['responsables'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "responsables", "sc_btn_responsables()", "sc_btn_responsables()", "sc_responsables_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_aprobada_label" id="hidden_field_label_aprobada" style="<?php echo $sStyleHidden_aprobada; ?>"><span id="id_label_aprobada"><?php echo $this->nm_new_label['aprobada']; ?></span></TD>
    <TD class="scFormDataOdd css_aprobada_line" id="hidden_field_data_aprobada" style="<?php echo $sStyleHidden_aprobada; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_aprobada_line" style="padding: 0px"><input type="hidden" name="aprobada" value="<?php echo $this->form_encode_input($aprobada); ?>"><span id="id_ajax_label_aprobada"><?php echo nl2br($aprobada); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_noaprobada_label" id="hidden_field_label_noaprobada" style="<?php echo $sStyleHidden_noaprobada; ?>"><span id="id_label_noaprobada"><?php echo $this->nm_new_label['noaprobada']; ?></span></TD>
    <TD class="scFormDataOdd css_noaprobada_line" id="hidden_field_data_noaprobada" style="<?php echo $sStyleHidden_noaprobada; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_noaprobada_line" style="padding: 0px"><input type="hidden" name="noaprobada" value="<?php echo $this->form_encode_input($noaprobada); ?>"><span id="id_ajax_label_noaprobada"><?php echo nl2br($noaprobada); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_escalar_label" id="hidden_field_label_escalar" style="<?php echo $sStyleHidden_escalar; ?>"><span id="id_label_escalar"><?php echo $this->nm_new_label['escalar']; ?></span></TD>
    <TD class="scFormDataOdd css_escalar_line" id="hidden_field_data_escalar" style="<?php echo $sStyleHidden_escalar; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_escalar_line" style="padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['Lookup_escalar'][] = 'Sin Atender'; ?>
 <option value="En Atencion" <?php  if ($this->escalar == "En Atencion") { echo " selected" ;} ?>>En Atencion</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['Lookup_escalar'][] = 'En Atencion'; ?>
 <option value="Rechazada" <?php  if ($this->escalar == "Rechazada") { echo " selected" ;} ?>>Rechazada</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['Lookup_escalar'][] = 'Rechazada'; ?>
 <option value="Finalizada" <?php  if ($this->escalar == "Finalizada") { echo " selected" ;} ?>>Finalizada</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['Lookup_escalar'][] = 'Finalizada'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_geocode_label" id="hidden_field_label_geocode" style="<?php echo $sStyleHidden_geocode; ?>"><span id="id_label_geocode"><?php echo $this->nm_new_label['geocode']; ?></span></TD>
    <TD class="scFormDataOdd css_geocode_line" id="hidden_field_data_geocode" style="<?php echo $sStyleHidden_geocode; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_geocode_line" style="vertical-align: top;padding: 0px"><script type="text/Javascript">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_audio_line" id="hidden_field_data_audio" style="<?php echo $sStyleHidden_audio; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_audio_line" style="vertical-align: top;padding: 0px"><span id="id_ajax_label_audio"><?php echo $audio?></span>
<input type="hidden" name="audio" value="<?php echo $this->form_encode_input($audio); ?>">
...
<?php
   if (isset($this->Ini->sc_lig_md5["form_baseconocimiento"]) && $this->Ini->sc_lig_md5["form_baseconocimiento"] == "S") {
       $Parms_Lig  = "nm_evt_ret_edit*scindo_ajax_form_alerta_lkpedt_refresh_motivo*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_alerta@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nm_evt_ret_edit*scindo_ajax_form_alerta_lkpedt_refresh_motivo*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_terminado_label" id="hidden_field_label_terminado" style="<?php echo $sStyleHidden_terminado; ?>"><span id="id_label_terminado"><?php echo $this->nm_new_label['terminado']; ?></span></TD>
    <TD class="scFormDataOdd css_terminado_line" id="hidden_field_data_terminado" style="<?php echo $sStyleHidden_terminado; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_terminado_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['Lookup_terminado'][] = '1'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_subcategoria_label" id="hidden_field_label_subcategoria" style="<?php echo $sStyleHidden_subcategoria; ?>"><span id="id_label_subcategoria"><?php echo $this->nm_new_label['subcategoria']; ?></span></TD>
    <TD class="scFormDataOdd css_subcategoria_line" id="hidden_field_data_subcategoria" style="<?php echo $sStyleHidden_subcategoria; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_subcategoria_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fecharechazada_label" id="hidden_field_label_fecharechazada" style="<?php echo $sStyleHidden_fecharechazada; ?>"><span id="id_label_fecharechazada"><?php echo $this->nm_new_label['fecharechazada']; ?></span></TD>
    <TD class="scFormDataOdd css_fecharechazada_line" id="hidden_field_data_fecharechazada" style="<?php echo $sStyleHidden_fecharechazada; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecharechazada_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fechaenatencion_label" id="hidden_field_label_fechaenatencion" style="<?php echo $sStyleHidden_fechaenatencion; ?>"><span id="id_label_fechaenatencion"><?php echo $this->nm_new_label['fechaenatencion']; ?></span></TD>
    <TD class="scFormDataOdd css_fechaenatencion_line" id="hidden_field_data_fechaenatencion" style="<?php echo $sStyleHidden_fechaenatencion; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechaenatencion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fechafinalizada_label" id="hidden_field_label_fechafinalizada" style="<?php echo $sStyleHidden_fechafinalizada; ?>"><span id="id_label_fechafinalizada"><?php echo $this->nm_new_label['fechafinalizada']; ?></span></TD>
    <TD class="scFormDataOdd css_fechafinalizada_line" id="hidden_field_data_fechafinalizada" style="<?php echo $sStyleHidden_fechafinalizada; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fechafinalizada_line" style="vertical-align: top;padding: 0px">
...
<?php $sStyleHidden_geo_dumb = ('' == $sStyleHidden_geo) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_geo_dumb" style="<?php echo $sStyleHidden_geo_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['Lookup_origenalerta'][] = 'Soma'; ?>
 <option value="WhatsApp" <?php  if ($this->origenalerta == "WhatsApp") { echo " selected" ;} ?>>WhatsApp</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['Lookup_origenalerta'][] = 'WhatsApp'; ?>
 <option value="OjoVoz" <?php  if ($this->origenalerta == "OjoVoz") { echo " selected" ;} ?>>OjoVoz</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['Lookup_origenalerta'][] = 'OjoVoz'; ?>
 <option value="Verbal" <?php  if ($this->origenalerta == "Verbal") { echo " selected" ;} ?>>Verbal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['Lookup_origenalerta'][] = 'Verbal'; ?>
 <option value="Escrita" <?php  if ($this->origenalerta == "Escrita") { echo " selected" ;} ?>>Escrita</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['Lookup_origenalerta'][] = 'Escrita'; ?>
 <option value="Correo" <?php  if ($this->origenalerta == "Correo") { echo " selected" ;} ?>>Correo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['Lookup_origenalerta'][] = 'Correo'; ?>
 </select></span>
</span><?php  }?>
...
<?php } 
?> 
<?php $sStyleHidden_canal_dumb = ('' == $sStyleHidden_canal) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_canal_dumb" style="<?php echo $sStyleHidden_canal_dumb; ?>"></TD>
<?php $sStyleHidden_origenalerta_dumb = ('' == $sStyleHidden_origenalerta) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_origenalerta_dumb" style="<?php echo $sStyleHidden_origenalerta_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_alerta");
 parent.scAjaxDetailHeight("form_alerta", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
