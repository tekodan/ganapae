...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_alerta_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_alerta'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['upload_field_info']['rutavideo'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_alerta_mob',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['upload_field_info']['rutaaudio'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_alerta_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_alerta_mob']['upload_field_info']['rutaimagen'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_alerta_mob',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_alerta_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_alerta_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_alerta_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_alerta_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_alerta_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_alerta_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - alerta";
      ...
      $_SESSION['scriptcase']['error_icon']['form_alerta_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_alerta_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['table_refresh'] = false;
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_field_ul_name'][$this->rutavideo_ul_name]))
          {
              $this->NM_ajax_info['param']['rutavideo_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_field_ul_name'][$this->rutavideo_ul_name];
          }
      ...
      elseif (isset($this->rutavideo_ul_name) && '' != $this->rutavideo_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_field_ul_name'][$this->rutavideo_ul_name]))
          {
              $this->rutavideo_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_field_ul_name'][$this->rutavideo_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_field_ul_name'][$this->rutaaudio_ul_name]))
          {
              $this->NM_ajax_info['param']['rutaaudio_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_field_ul_name'][$this->rutaaudio_ul_name];
          }
      ...
      elseif (isset($this->rutaaudio_ul_name) && '' != $this->rutaaudio_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_field_ul_name'][$this->rutaaudio_ul_name]))
          {
              $this->rutaaudio_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_field_ul_name'][$this->rutaaudio_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_field_ul_name'][$this->rutaimagen_ul_name]))
          {
              $this->NM_ajax_info['param']['rutaimagen_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_field_ul_name'][$this->rutaimagen_ul_name];
          }
      ...
      elseif (isset($this->rutaimagen_ul_name) && '' != $this->rutaimagen_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_field_ul_name'][$this->rutaimagen_ul_name]))
          {
              $this->rutaimagen_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_field_ul_name'][$this->rutaimagen_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_alerta_mob']['goto'];
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['embutida_liga_form_insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['embutida_liga_form_insert'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['dados_form'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_alerta_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_alerta/form_alerta_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_alerta_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_alerta_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_alerta_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_alerta/form_alerta_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_alerta_mob_erro.class.php"); 
      }
      $this->Erro      = new form_alerta_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opcao']))
         { 
             if ($this->idalerta != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_alerta_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['responsables'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['botoes']['responsables'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['dados_select'];
     }
   }
...
//
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_alerta_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_alerta_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['dados_select']['origenalerta']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->origenalerta = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['dados_select']['origenalerta'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['recarga'] = $this->nmgp_opcao;
      }
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_alerta_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_alerta_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_alerta_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_alerta_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
;
    ...
    {
        global $teste_validade;
               if (!empty($this->categoria) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_categoria']) && !in_array($this->categoria, $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_categoria']))
               {
    ...
    {
        global $teste_validade;
               if (!empty($this->subcategoria) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_subcategoria']) && !in_array($this->subcategoria, $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_subcategoria']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->estado) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_estado']) && !in_array($this->estado, $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_estado']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->municipio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_municipio']) && !in_array($this->municipio, $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_municipio']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    {
        global $teste_validade;
               if (!empty($this->lugar) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_lugar']) && !in_array($this->lugar, $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_lugar']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_rutavideo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            {
                include_once 'form_alerta_mob_doc_name.php';
            }
...
//--------------------------------------------------------------------------------------
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idalerta']['keyVal'] = form_alerta_mob_pack_protect_string($this->nmgp_dados_form['idalerta']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_alerta_mob_pack_protect_string('Sin Atender') => form_alerta_mob_pack_protect_string("Sin Atender"));
$aLookup[] = array(form_alerta_mob_pack_protect_string('En Atencion') => form_alerta_mob_pack_protect_string("En Atencion"));
$aLookup[] = array(form_alerta_mob_pack_protect_string('Rechazada') => form_alerta_mob_pack_protect_string("Rechazada"));
$aLookup[] = array(form_alerta_mob_pack_protect_string('Finalizada') => form_alerta_mob_pack_protect_string("Finalizada"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_escalar'][] = 'Sin Atender';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_escalar'][] = 'En Atencion';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_escalar'][] = 'Rechazada';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_escalar'][] = 'Finalizada';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['escalar']['valList'][$i] = form_alerta_mob_pack_protect_string($v);
          }
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_alerta_mob_pack_protect_string(NM_charset_to_utf8($this->motivo))]) ? $aLookup[0][form_alerta_mob_pack_protect_string(NM_charset_to_utf8($this->motivo))] : "";
...
$aLookup[] = array(form_alerta_mob_pack_protect_string('1') => form_alerta_mob_pack_protect_string("Ok"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_terminado'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['terminado']['valList'][$i] = form_alerta_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_alerta_mob_pack_protect_string('Categoria') => form_alerta_mob_pack_protect_string('Categoria'));
...
ORDER BY nombre";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['categoria']['valList'][$i] = form_alerta_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
ORDER BY categoria";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['subcategoria']['valList'][$i] = form_alerta_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_alerta_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_alerta_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['estado']['valList'][$i] = form_alerta_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_alerta_mob_pack_protect_string('Municipio') => form_alerta_mob_pack_protect_string('Municipio'));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_municipio'][] = 'Municipio';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['municipio']['valList'][$i] = form_alerta_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
ORDER BY NOMBRE_SEDE_EDUCATIVA";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['lugar']['valList'][$i] = form_alerta_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_alerta_mob_pack_protect_string('Soma') => form_alerta_mob_pack_protect_string("Soma"));
$aLookup[] = array(form_alerta_mob_pack_protect_string('WhatsApp') => form_alerta_mob_pack_protect_string("WhatsApp"));
$aLookup[] = array(form_alerta_mob_pack_protect_string('OjoVoz') => form_alerta_mob_pack_protect_string("OjoVoz"));
$aLookup[] = array(form_alerta_mob_pack_protect_string('Verbal') => form_alerta_mob_pack_protect_string("Verbal"));
$aLookup[] = array(form_alerta_mob_pack_protect_string('Escrita') => form_alerta_mob_pack_protect_string("Escrita"));
$aLookup[] = array(form_alerta_mob_pack_protect_string('Correo') => form_alerta_mob_pack_protect_string("Correo"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_origenalerta'][] = 'Soma';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_origenalerta'][] = 'WhatsApp';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_origenalerta'][] = 'OjoVoz';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_origenalerta'][] = 'Verbal';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_origenalerta'][] = 'Escrita';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['Lookup_origenalerta'][] = 'Correo';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['origenalerta']['valList'][$i] = form_alerta_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   { 
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
      ...
      $_SESSION['scriptcase']['form_alerta_mob']['contr_erro'] = 'on';
...
else
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_alerta_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_alerta_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->motivo = $this->motivo_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_alerta_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['parms'] = "idalerta?#?$this->idalerta?@?"; 
      }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['where_filter_form'];
      }
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_alerta_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['total'] = $qt_geral_reg_form_alerta_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idalerta))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_alerta_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start'] > $qt_geral_reg_form_alerta_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start'] = $qt_geral_reg_form_alerta_mob; 
          }
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      if ($this->nmgp_opcao != "novo" && $this->nmgp_opcao != "nada" && $this->nmgp_opcao != "refresh_insert") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start']) ;  
              } 
          } 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['parms'] = "idalerta?#?$this->idalerta?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['sub_dir'][0]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['sub_dir'][1]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['sub_dir'][2]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['reg_start'] < $qt_geral_reg_form_alerta_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['dados_select'];
                  $this->subcategoria = $this->nmgp_dados_select['subcategoria'];  
                  ...
                  $this->fecharechazada = $this->nmgp_dados_select['fecharechazada'];  
                  $this->fechaenatencion = $this->nmgp_dados_select['fechaenatencion'];  
                  $this->fechafinalizada = $this->nmgp_dados_select['fechafinalizada'];  
              }
          }
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta']['foreign_key']))
          {
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
    ...
    include_once("form_alerta_mob_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['empty_filter']);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_alerta_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_alerta_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_alerta_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['masterValue']))
{
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_alerta_mob']['retorno_edit'] = "";
   }
