...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fecharechazada_hora' + iSeqRow).bind('blur', function() { sc_form_alerta_fecharechazada_onblur(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_alerta_fecharechazada_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_fechaenatencion_hora' + iSeqRow).bind('blur', function() { sc_form_alerta_fechaenatencion_onblur(this, iSeqRow) })
                                                  .bind('focus', function() { sc_form_alerta_fechaenatencion_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_fechafinalizada_hora' + iSeqRow).bind('blur', function() { sc_form_alerta_fechafinalizada_onblur(this, iSeqRow) })
                                                  .bind('focus', function() { sc_form_alerta_fechafinalizada_onfocus(this, iSeqRow) });
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_rutavideo" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_alerta_mob_ul_save.php",
