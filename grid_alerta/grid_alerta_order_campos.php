<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_alerta_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_alerta_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['idalerta'] = "on";
   $tab_def_campos['idalerta'] = "idalerta";
   $tab_converte["idalerta"]   = "idalerta";
   $tab_labels["idalerta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["idalerta"])) ? $_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["idalerta"] : "Id";
   $tab_ger_campos['semaforo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['semaforo'] = "Semaforo";
       $tab_converte["Semaforo"]   = "semaforo";
   }
   else
   {
       $tab_def_campos['semaforo'] = "";
       $tab_converte[""]   = "semaforo";
   }
   $tab_labels["semaforo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["semaforo"])) ? $_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["semaforo"] : "+";
   $tab_ger_campos['alerta'] = "on";
   $tab_def_campos['alerta'] = "alerta";
   $tab_converte["alerta"]   = "alerta";
   $tab_labels["alerta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["alerta"])) ? $_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["alerta"] : "Alerta";
   $tab_ger_campos['rutaimagen'] = "on";
   $tab_def_campos['rutaimagen'] = "rutaimagen";
   $tab_converte["rutaimagen"]   = "rutaimagen";
   $tab_labels["rutaimagen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["rutaimagen"])) ? $_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["rutaimagen"] : "Imagen";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_converte["fecha"]   = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['municipio'] = "on";
   $tab_def_campos['municipio'] = "municipio";
   $tab_converte["municipio"]   = "municipio";
   $tab_labels["municipio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["municipio"])) ? $_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["municipio"] : "Municipio";
   $tab_ger_campos['alert'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['alert'] = "alert";
       $tab_converte["alert"]   = "alert";
   }
   else
   {
       $tab_def_campos['alert'] = "";
       $tab_converte[""]   = "alert";
   }
   $tab_labels["alert"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["alert"])) ? $_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["alert"] : "Alerta";
   ...
   {
       $tab_def_campos['state'] = "";
       $tab_converte[""]   = "state";
   }
   $tab_labels["state"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["state"])) ? $_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["state"] : "Estado";
   $tab_ger_campos['audio'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['audio'] = "audio";
       $tab_converte["audio"]   = "audio";
   }
   else
   {
       $tab_def_campos['audio'] = "";
       $tab_converte[""]   = "audio";
   }
   $tab_labels["audio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["audio"])) ? $_SESSION['sc_session'][$sc_init]['grid_alerta']['labels']["audio"] : "audio";
   $tab_ger_campos['semaforo'] = "none";
   $tab_ger_campos['alert'] = "none";
   $tab_ger_campos['state'] = "none";
   $tab_ger_campos['audio'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_alerta']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_alerta']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_alerta']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_alerta']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_alerta']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_alerta']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_alerta']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_alerta']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_alerta']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_alerta_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_alerta']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_alerta']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
