...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["alert_____grid_alerta"]))
   {
      unset($_SESSION['session_sec_aplicacao']["alert_____grid_alerta"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_alerta'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_alerta']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_alerta']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_alerta']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_alerta']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_alerta']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_alerta']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_alerta']['embutida_filho'] as $ind => $sc_init)
          {
