...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_categorias_mob_validate_subcategoria()
  {
    var nomeCampo_subcategoria = "subcategoria";
    var var_subcategoria = scAjaxGetFieldText(nomeCampo_subcategoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_mob_validate_subcategoria(var_subcategoria, var_script_case_init, do_ajax_form_categorias_mob_validate_subcategoria_cb);
  } // do_ajax_form_categorias_mob_validate_subcategoria

  function do_ajax_form_categorias_mob_validate_subcategoria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_mob_validate_subcategoria_cb
  // ---------- Form
  function do_ajax_form_categorias_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_categorias_mob_submit_form(var_nombre, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_categorias_mob_submit_form_cb);
  ...
  var scStatusDetail = {};
  scStatusDetail["form_subcategoria"] = "off";
  ...
  function do_ajax_form_categorias_mob_navigate_form()
  {
    ...
    scAjaxProcOn();
    scStatusDetail["form_subcategoria"] = "on";
    x_ajax_form_categorias_mob_navigate_form(var_nombre, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_categorias_mob_navigate_form_cb);
  ...
  function do_ajax_form_categorias_mob_navigate_form_cb(sResp)
  {
    ...
    document.getElementById('nmsc_iframe_liga_form_subcategoria').contentWindow.nm_move('apl_detalhe', true);
    document.getElementById('nmsc_iframe_liga_form_subcategoria').style.height = "1";
    document.getElementById('nmsc_iframe_liga_form_subcategoria').style.display = "none";
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert();
    scAjaxMessage();
...
?>
  ...
  {
    if ("off" == scStatusDetail["form_subcategoria"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "subcategoria";
