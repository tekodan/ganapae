...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["alert_____grid_grupos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["alert_____grid_grupos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_grupos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_grupos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_grupos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_grupos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_grupos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_grupos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_grupos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_grupos']['embutida_filho'] as $ind => $sc_init)
          {
