...
$old_error_handler = set_error_handler("form_documentacion_scriptcase_error_handler");

function form_documentacion_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_documentacion']['contr_erro']) && $_SESSION['scriptcase']['form_documentacion']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_documentacion->contr_form_documentacion->Apl_com_erro = true;
            if ($inicial_form_documentacion->contr_form_documentacion->NM_ajax_flag)
            {
                $inicial_form_documentacion->contr_form_documentacion->NM_ajax_info['errList']['geral_form_documentacion'][] = $msg;
                return;
            }
            form_documentacion_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_documentacion_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_documentacion'])  && '' != $_SESSION['scriptcase']['error_icon']['form_documentacion'])  ? $_SESSION['scriptcase']['error_icon']['form_documentacion']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_documentacion']) && '' != $_SESSION['scriptcase']['error_close']['form_documentacion']) ? $_SESSION['scriptcase']['error_close']['form_documentacion'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_documentacion']) && '' != $_SESSION['scriptcase']['error_span_title']['form_documentacion']) ? $_SESSION['scriptcase']['error_span_title']['form_documentacion'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_documentacion']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_documentacion']) ? $_SESSION['scriptcase']['error_icon_title']['form_documentacion'] : '';
?>
