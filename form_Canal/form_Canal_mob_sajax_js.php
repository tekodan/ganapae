  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_Canal_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nombre
  function do_ajax_form_Canal_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Canal_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_Canal_mob_validate_nombre_cb);
  } // do_ajax_form_Canal_mob_validate_nombre

  function do_ajax_form_Canal_mob_validate_nombre_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Canal_mob_validate_nombre_cb

  // ---------- Validate descripcion
  function do_ajax_form_Canal_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Canal_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_Canal_mob_validate_descripcion_cb);
  } // do_ajax_form_Canal_mob_validate_descripcion

  function do_ajax_form_Canal_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Canal_mob_validate_descripcion_cb

  // ---------- Validate privado
  function do_ajax_form_Canal_mob_validate_privado()
  {
    var nomeCampo_privado = "privado";
    var var_privado = scAjaxGetFieldText(nomeCampo_privado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Canal_mob_validate_privado(var_privado, var_script_case_init, do_ajax_form_Canal_mob_validate_privado_cb);
  } // do_ajax_form_Canal_mob_validate_privado

  function do_ajax_form_Canal_mob_validate_privado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "privado";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Canal_mob_validate_privado_cb
  // ---------- Form
  function do_ajax_form_Canal_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_Canal_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nombre = scAjaxGetFieldText("nombre");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_privado = scAjaxGetFieldText("privado");
    ...
    scAjaxProcOn();
    x_ajax_form_Canal_mob_submit_form(var_nombre, var_descripcion, var_privado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_Canal_mob_submit_form_cb);
  } // do_ajax_form_Canal_mob_submit_form

  function do_ajax_form_Canal_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("privado");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_Canal_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_Canal_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("descripcion");
    scAjaxHideErrorDisplay("privado");
    var var_nombre = document.F2.nombre.value;
    ...
    scAjaxProcOn();
    x_ajax_form_Canal_mob_navigate_form(var_nombre, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_Canal_mob_navigate_form_cb);
  } // do_ajax_form_Canal_mob_navigate_form

  function do_ajax_form_Canal_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_Canal_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.nombre.value = scAjaxGetKeyValue("nombre");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_Canal_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_Canal_mob_navigate_form_cb
  function sc_hide_form_Canal_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "privado": {"label": "Privado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["privado"][1] = "privado";
  ...
  var ajax_field_id = {
    ...
    "privado": new Array("hidden_field_label_privado", "hidden_field_data_privado")
  };
