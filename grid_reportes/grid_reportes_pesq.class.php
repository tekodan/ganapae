...
class grid_reportes_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_reportes_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_reportes_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_reportes_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_refresh_field")
      {
          ...
          if (in_array("subcategoria", $NMcmp_refr))
          {
              $list = array();
              $nmgp_def_dados = $this->lookup_ajax_subcategoria($categoria);
              ...
              $this->Arr_result['set_option'][] = array('field' => 'SC_subcategoria', 'value' => $list);
          }
          if (in_array("lugar", $NMcmp_refr))
          {
              $list = array();
              $nmgp_def_dados = $this->lookup_ajax_lugar($municipio);
              foreach ($nmgp_def_dados as $ind => $parms)
              {
                  foreach ($parms as $opt => $val)
                  {
              ...
              $this->Arr_result['set_option'][] = array('field' => 'SC_lugar', 'value' => $list);
          }
      }
   }
   function lookup_ajax_subcategoria($categoria)
   {
      $categoria_val_str = "''";
      if (is_array($categoria) && !empty($categoria))
      {
         $tmp_array = array();
         $categoria_val_str = "";
         foreach ($categoria as $tmp_val_cmp)
         {
            if ("" != $categoria_val_str)
            {
               $categoria_val_str .= ", ";
            }
            ...
            $categoria_val_str .= "'$tmp_val_cmp'";
         }
      }
            $subcategoria_look = substr($this->Db->qstr($subcategoria), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "SELECT nombre, nombre  FROM subcategoria where categoria IN ($categoria_val_str) ORDER BY nombre"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['subcategoria'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['subcategoria'][] = trim($rs->fields[0]);
   ...
   function lookup_ajax_lugar($municipio)
   {
      $tmp_pos = strpos($municipio, "##@@");
      if ($tmp_pos !== false)
      {
          $municipio = substr($municipio, 0, $tmp_pos);
      }
            $lugar_look = substr($this->Db->qstr($lugar), 1, -1); 
      $nmgp_def_dados = array(); 
      $nmgp_def_dados[] = array("" => "Institucion"); 
      $nm_comando = "SELECT NOMBRE_SEDE_EDUCATIVA, NOMBRE_SEDE_EDUCATIVA  FROM colegios WHERE municipio='$municipio' ORDER BY NOMBRE_SEDE_EDUCATIVA"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['lugar'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['lugar'][] = trim($rs->fields[0]);
            $cmp1 = NM_charset_to_utf8(trim($rs->fields[0]));
            $cmp2 = NM_charset_to_utf8(trim($rs->fields[1]));
            $nmgp_def_dados[] = array($cmp1 . "##@@" . $cmp2 => $cmp2); 
            $rs->MoveNext() ; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - alerta</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_reportes/grid_reportes_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_reportes_ajax_search.js"></script>
 <script type="text/javascript" src="grid_reportes_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_subcategoria_cond#NMF#' + search_get_sel_txt('SC_subcategoria_cond') + '@NMF@';
  str_out += 'SC_subcategoria#NMF#' + search_get_select('SC_subcategoria') + '@NMF@';
  str_out += 'SC_categoria_cond#NMF#' + search_get_sel_txt('SC_categoria_cond') + '@NMF@';
  str_out += 'SC_categoria#NMF#' + search_get_selmult('SC_categoria') + '@NMF@';
  ...
  str_out += 'SC_escalar_cond#NMF#' + search_get_sel_txt('SC_escalar_cond') + '@NMF@';
  str_out += 'SC_escalar#NMF#' + search_get_select('SC_escalar') + '@NMF@';
  str_out += 'SC_terminado_cond#NMF#' + search_get_sel_txt('SC_terminado_cond') + '@NMF@';
  str_out += 'SC_terminado#NMF#' + search_get_select('SC_terminado') + '@NMF@';
  str_out += 'SC_municipio_cond#NMF#' + search_get_sel_txt('SC_municipio_cond') + '@NMF@';
  str_out += 'SC_municipio#NMF#' + search_get_select('SC_municipio') + '@NMF@';
  str_out += 'SC_lugar_cond#NMF#' + search_get_sel_txt('SC_lugar_cond') + '@NMF@';
  str_out += 'SC_lugar#NMF#' + search_get_select('SC_lugar') + '@NMF@';
 ...
 function nm_refresh_categoria()
 {
   var parms  = "";
   var fields = "subcategoria";
   parms += 'categoria#NMF#' + search_get_selmult('SC_categoria') + '@NMF@';
   ajax_refresh_field(fields, parms);
 }
 function nm_refresh_municipio()
 {
   var parms  = "";
   var fields = "lugar";
   parms += 'municipio#NMF#' + search_get_select('SC_municipio') + '@NMF@';
   ajax_refresh_field(fields, parms);
 }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - alerta</span></td>
...
<?php
   ...
   {
      global 
             $subcategoria_cond, $subcategoria,
             $categoria_cond, $categoria,
             $fecha_cond, $fecha, $fecha_dia, $fecha_mes, $fecha_ano, $fecha_input_2_dia, $fecha_input_2_mes, $fecha_input_2_ano,
             $escalar_cond, $escalar,
             $terminado_cond, $terminado,
             $municipio_cond, $municipio,
             $lugar_cond, $lugar,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $subcategoria = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['subcategoria']; 
          $subcategoria_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['subcategoria_cond']; 
          $categoria = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['categoria']; 
          $categoria_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['categoria_cond']; 
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha_input_2_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha_cond']; 
          $escalar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['escalar']; 
          $escalar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['escalar_cond']; 
          $terminado = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['terminado']; 
          $terminado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['terminado_cond']; 
          $municipio = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['municipio']; 
          $municipio_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['municipio_cond']; 
          $lugar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['lugar']; 
          $lugar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['lugar_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['NM_operador']; 
      } 
      if (!isset($subcategoria_cond) || empty($subcategoria_cond))
      {
         $subcategoria_cond = "qp";
      }
      ...
      if (!isset($escalar_cond) || empty($escalar_cond))
      {
         $escalar_cond = "qp";
      }
      if (!isset($terminado_cond) || empty($terminado_cond))
      {
         $terminado_cond = "gt";
      }
      if (!isset($municipio_cond) || empty($municipio_cond))
      {
         $municipio_cond = "qp";
      }
      ...
      $str_hide_subcategoria = (in_array($subcategoria_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_escalar = (in_array($escalar_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_terminado = (in_array($terminado_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_municipio = (in_array($municipio_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_terminado = ('bw' == $terminado_cond) ? $display_aberto : $display_fechado;
      ...
      {
         $tmp_pos = strpos($subcategoria, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $subcategoria = substr($subcategoria, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($escalar) || $escalar == "")
      {
          $escalar = "";
      }
      if (isset($escalar) && !empty($escalar))
      {
         $tmp_pos = strpos($escalar, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $escalar = substr($escalar, 0, $tmp_pos);
         }
      }
      if (!isset($terminado) || $terminado == "")
      {
          $terminado = "";
      }
      if (isset($terminado) && !empty($terminado))
      {
         $tmp_pos = strpos($terminado, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $terminado = substr($terminado, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("grid_reportes_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
     ...
     <TD >
         <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['subcategoria'])) ? $this->New_label['subcategoria'] : "Subcategoria"; ?></TD>
     </TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_subcategoria_cond" name="subcategoria_cond" onChange="nm_campos_between(document.getElementById('id_vis_subcategoria'), this, 'subcategoria')">
       <OPTION value="qp" <?php if ("qp" == $subcategoria_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $subcategoria_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $subcategoria_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $subcategoria_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
 ...
 $nmgp_tab_label .= "subcategoria?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
...
?>
   <span id="idAjaxSelect_subcategoria">
      <SELECT class="scFilterObjectOdd" id="SC_subcategoria" name="subcategoria"  size="1">
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $subcategoria)
            {
                    $subcategoria_sel = ($nm_opc_cod === $subcategoria) ? "selected" : "";
            }
            else
            {
               $subcategoria_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $subcategoria_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
     ...
     <TD >
         <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['categoria'])) ? $this->New_label['categoria'] : "Categoria"; ?></TD>
     </TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_categoria_cond" name="categoria_cond" onChange="nm_campos_between(document.getElementById('id_vis_categoria'), this, 'categoria')">
...
<?php
      $categoria_look = substr($this->Db->qstr($categoria), 1, -1); 
      $nmgp_def_dados = "" ; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['categoria'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['categoria'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_categoria">
      <SELECT class="scFilterObjectEven" id="SC_categoria" name="categoria[]" onChange="nm_refresh_categoria();" size="7" multiple>
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
               $categoria_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $categoria_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
     ...
     <TD >
         <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['escalar'])) ? $this->New_label['escalar'] : "Escalar"; ?></TD>
     </TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_escalar_cond" name="escalar_cond" onChange="nm_campos_between(document.getElementById('id_vis_escalar'), this, 'escalar')">
       <OPTION value="qp" <?php if ("qp" == $escalar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $escalar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $escalar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $escalar_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "escalar?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['escalar'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['escalar'][] = "SI";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['escalar'][] = "";
 ?>

 <SELECT class="scFilterObjectEven" id="SC_escalar"  name="escalar"  size="1">
 <OPTION value="SI##@@SI"<?php if ($escalar == "SI") { echo " selected" ;} ?>>SI</option>
 <OPTION value="##@@"<?php if ($escalar == "") { echo " selected" ;} ?>></option>
 </SELECT>
     ...
     <TD >
         <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['terminado'])) ? $this->New_label['terminado'] : "Terminado"; ?></TD>
     </TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_terminado_cond" name="terminado_cond" onChange="nm_campos_between(document.getElementById('id_vis_terminado'), this, 'terminado')">
       <OPTION value="gt" <?php if ("gt" == $terminado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $terminado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $terminado_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "terminado?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['terminado'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['terminado'][] = "OK";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['terminado'][] = "";
 ?>

 <SELECT class="scFilterObjectOdd" id="SC_terminado"  name="terminado"  size="1">
 <OPTION value="OK##@@OK"<?php if ($terminado == "OK") { echo " selected" ;} ?>>OK</option>
 <OPTION value="##@@"<?php if ($terminado == "") { echo " selected" ;} ?>></option>
 </SELECT>
     ...
     <TD >
         <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['municipio'])) ? $this->New_label['municipio'] : "Municipio"; ?></TD>
     </TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_municipio_cond" name="municipio_cond" onChange="nm_campos_between(document.getElementById('id_vis_municipio'), this, 'municipio')">
       <OPTION value="qp" <?php if ("qp" == $municipio_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $municipio_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $municipio_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $municipio_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "municipio?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>

<?php
      $municipio_look = substr($this->Db->qstr($municipio), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT MUNICIPIO, MUNICIPIO  FROM municipios  ORDER BY MUNICIPIO"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['municipio'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['municipio'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_municipio">
      <SELECT class="scFilterObjectEven" id="SC_municipio" name="municipio" onChange="nm_refresh_municipio();" size="1">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $municipio)
            {
                    $municipio_sel = ($nm_opc_cod === $municipio) ? "selected" : "";
            }
            else
            {
               $municipio_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $municipio_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
     ...
     <TD >
         <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['lugar'])) ? $this->New_label['lugar'] : "Lugar"; ?></TD>
     </TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_lugar_cond" name="lugar_cond" onChange="nm_campos_between(document.getElementById('id_vis_lugar'), this, 'lugar')">
...
?>
   <span id="idAjaxSelect_lugar">
      <SELECT class="scFilterObjectOdd" id="SC_lugar" name="lugar"  size="1">
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $lugar)
            {
                    $lugar_sel = ($nm_opc_cod === $lugar) ? "selected" : "";
            }
            else
            {
               $lugar_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $lugar_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['opc_psq'] && !$this->aba_iframe))
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_subcategoria'), document.F1.subcategoria_cond, 'subcategoria');
   document.F1.subcategoria.value = "";
   nm_campos_between(document.getElementById('id_vis_categoria'), document.F1.categoria_cond, 'categoria');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'categoria[]')
      {
   ...
   nm_campos_between(document.getElementById('id_vis_escalar'), document.F1.escalar_cond, 'escalar');
   document.F1.escalar.value = "";
   nm_campos_between(document.getElementById('id_vis_terminado'), document.F1.terminado_cond, 'terminado');
   document.F1.terminado.value = "";
   nm_campos_between(document.getElementById('id_vis_municipio'), document.F1.municipio_cond, 'municipio');
   document.F1.municipio.value = "";
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_reportes_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_reportes_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_reportes_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_reportes_valida_mes(this)});
 }
 function sc_grid_reportes_valida_dia(obj)
 {
 ...
 function sc_grid_reportes_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_subcategoria_cond'] = 'cond';
      $tp_fields['SC_subcategoria'] = 'select';
      $tp_fields['SC_categoria_cond'] = 'cond';
      $tp_fields['SC_categoria'] = 'selmult';
      ...
      $tp_fields['SC_escalar_cond'] = 'cond';
      $tp_fields['SC_escalar'] = 'select';
      $tp_fields['SC_terminado_cond'] = 'cond';
      $tp_fields['SC_terminado'] = 'select';
      $tp_fields['SC_municipio_cond'] = 'cond';
      $tp_fields['SC_municipio'] = 'select';
      $tp_fields['SC_lugar_cond'] = 'cond';
      $tp_fields['SC_lugar'] = 'select';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $subcategoria_cond, $subcategoria,
             $categoria_cond, $categoria,
             $fecha_cond, $fecha, $fecha_dia, $fecha_mes, $fecha_ano, $fecha_input_2_dia, $fecha_input_2_mes, $fecha_input_2_ano,
             $escalar_cond, $escalar,
             $terminado_cond, $terminado,
             $municipio_cond, $municipio,
             $lugar_cond, $lugar, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $subcategoria_cond_salva = $subcategoria_cond; 
      if (!isset($subcategoria_input_2) || $subcategoria_input_2 == "")
      {
          $subcategoria_input_2 = $subcategoria;
      }
      ...
      $escalar_cond_salva = $escalar_cond; 
      if (!isset($escalar_input_2) || $escalar_input_2 == "")
      {
          $escalar_input_2 = $escalar;
      }
      $terminado_cond_salva = $terminado_cond; 
      if (!isset($terminado_input_2) || $terminado_input_2 == "")
      {
          $terminado_input_2 = $terminado;
      }
      $municipio_cond_salva = $municipio_cond; 
      if (!isset($municipio_input_2) || $municipio_input_2 == "")
      {
          $municipio_input_2 = $municipio;
      }
      ...
      $tmp_pos = strpos($subcategoria, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $subcategoria;
      }
      else {
          $L_lookup = substr($subcategoria, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['subcategoria'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Subcategoria : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($categoria, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $categoria;
      }
      else {
          $L_lookup = substr($categoria, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['categoria'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Categoria : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($escalar, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $escalar;
          ...
          $L_lookup = substr($escalar, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['escalar'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Escalar : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($terminado, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $terminado;
          ...
          $L_lookup = substr($terminado, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['terminado'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Terminado : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($municipio, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $municipio;
          ...
          $L_lookup = substr($municipio, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['municipio'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Municipio : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($lugar, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $lugar;
          ...
          $L_lookup = substr($lugar, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['psq_check_ret']['lugar'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Lugar : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['subcategoria'] = $subcategoria; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['subcategoria_cond'] = $subcategoria_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['categoria'] = $categoria; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['categoria_cond'] = $categoria_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['escalar'] = $escalar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['escalar_cond'] = $escalar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['terminado'] = $terminado; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['terminado_cond'] = $terminado_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['municipio'] = $municipio; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['municipio_cond'] = $municipio_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['lugar'] = $lugar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['lugar_cond'] = $lugar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      $this->cmp_formatado['subcategoria'] = $Conteudo;
      $this->cmp_formatado['categoria'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['categoria'];
      $this->cmp_formatado['categoria_input_2'] = $categoria_input_2;
      $Conteudo = $escalar;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['escalar'] = $Conteudo;
      $Conteudo = $terminado;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['terminado'] = $Conteudo;
      $Conteudo = $municipio;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['municipio'] = $Conteudo;
      $Conteudo = $lugar;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['lugar'] = $Conteudo;

      //----- $subcategoria
      $this->Date_part = false;
      if (isset($subcategoria))
      {
         $this->monta_condicao("subcategoria", $subcategoria_cond, $subcategoria, "", "subcategoria");
      }
      ...
      {
         $this->and_or();
         if (strtoupper($categoria_cond) == "DF" || strtoupper($categoria_cond) == "NP")
         {
             $this->comando        .= " categoria not in (";
             $this->comando_sum    .= " alerta.categoria not in (";
             $this->comando_filtro .= " categoria not in (";
         }
         else
         {
             $this->comando        .= " categoria in (";
             $this->comando_sum    .= " alerta.categoria in (";
             $this->comando_filtro .= " categoria in (";
         }
         $x                     = count($categoria);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $this->comando_sum    .= ")";
         $this->comando_filtro .= ")";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $nmgp_tab_label['categoria'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if ($fecha_cond != "TP")
      {
          ...
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $fecha_cond , "");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $fecha_cond , "");
          }
          $fecha = $val[0];
          $this->cmp_formatado['fecha'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']['fecha_input_2'] = $val[1];
      ...
      if (isset($escalar))
      {
         $this->monta_condicao("escalar", $escalar_cond, $escalar, "", "escalar");
      }
      ...
      if (isset($terminado))
      {
         $this->monta_condicao("terminado", $terminado_cond, $terminado, "", "terminado");
      }
      ...
      if (isset($municipio))
      {
         $this->monta_condicao("municipio", $municipio_cond, $municipio, "", "municipio");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['where_pesq_ant'] = $this->comando . $this->comando_fim;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "subcategoria" : return ('class="scFilterObjectOdd"'); break;
         case "categoria" : return ('class="scFilterObjectEven"'); break;
         case "municipio" : return ('class="scFilterObjectEven"'); break;
         case "lugar" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
