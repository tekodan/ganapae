<?php
   ...
   $Sel_Groupby = new grid_reportes_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class grid_reportes_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_reportes']['SC_Ind_Groupby'];
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['grid_reportes']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['grid_reportes']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       $_SESSION['sc_session'][$sc_init]['grid_reportes']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['grid_reportes']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['grid_reportes']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['grid_reportes']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reportes']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reportes']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reportes']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reportes']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reportes']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reportes']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reportes']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reportes']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reportes']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reportes']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reportes']['pivot_tabular']);
       if ($sel_groupby == "sc_free_group_by")
       {
           $tab_arr_groubby_cmp = array();
           $tab_arr_groubby_sql = array();
           $tab_arr_groubby_cmp['subcategoria'] = array('cmp' => "subcategoria", 'ind' => 0);
           $tab_arr_groubby_cmp['categoria'] = array('cmp' => "categoria", 'ind' => 1);
           $tab_arr_groubby_cmp['municipio'] = array('cmp' => "municipio", 'ind' => 2);
           $tab_arr_groubby_cmp['lugar'] = array('cmp' => "lugar", 'ind' => 3);
           $tab_arr_groubby_cmp['fecha'] = array('cmp' => "fecha", 'ind' => 4);
           $tab_arr_groubby_cmp['escalar'] = array('cmp' => "escalar", 'ind' => 5);
           $tab_arr_groubby_cmp['terminado'] = array('cmp' => "terminado", 'ind' => 6);
           $tab_arr_groubby_sql[0] = array('cmp' => "subcategoria", 'ord' => 'asc');
           $tab_arr_groubby_sql[1] = array('cmp' => "categoria", 'ord' => 'asc');
           $tab_arr_groubby_sql[2] = array('cmp' => "municipio", 'ord' => 'asc');
           $tab_arr_groubby_sql[3] = array('cmp' => "lugar", 'ord' => 'asc');
           $tab_arr_groubby_sql[4] = array('cmp' => "fecha", 'ord' => 'asc');
           $tab_arr_groubby_sql[5] = array('cmp' => "escalar", 'ord' => 'asc');
           $tab_arr_groubby_sql[6] = array('cmp' => "terminado", 'ord' => 'asc');
           $_SESSION['sc_session'][$sc_init]['grid_reportes']['SC_Gb_Free_cmp'] = array();
           $_SESSION['sc_session'][$sc_init]['grid_reportes']['SC_Gb_Free_sql'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['grid_reportes']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['grid_reportes']['SC_Gb_Free_sql'][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
               }
           }
       }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       $_SESSION['sc_session'][$sc_init]['grid_reportes']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['grid_reportes']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo")
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       foreach ($_SESSION['sc_session'][$sc_init]['grid_reportes']['summarizing_fields_display'] as $i_sum => $d_sum)
       {
           $_SESSION['sc_session'][$sc_init]['grid_reportes']['summarizing_fields_display'][$i_sum]['display'] = in_array($i_sum, $summ_fields);
       }
       $_SESSION['sc_session'][$sc_init]['grid_reportes']['summarizing_fields_order'] = $summ_fields;
   }
?>
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['subcategoria']  = (isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']['subcategoria'])) ? $_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']['subcategoria'] : "Subcategoria";
   $arr_campos_free['categoria']  = (isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']['categoria'])) ? $_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']['categoria'] : "Categoria";
   $arr_campos_free['municipio']  = (isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']['municipio'])) ? $_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']['municipio'] : "Municipio";
   $arr_campos_free['lugar']  = (isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']['lugar'])) ? $_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']['lugar'] : "Lugar";
   $arr_campos_free['fecha']  = (isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']['fecha'])) ? $_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']['fecha'] : "Fecha";
   $arr_campos_free['escalar']  = (isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']['escalar'])) ? $_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']['escalar'] : "Escalar";
   $arr_campos_free['terminado']  = (isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']['terminado'])) ? $_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']['terminado'] : "Terminado";
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - alerta</TITLE>
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "grid_reportes_sel_groupby.php",
    data: {
...
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_reportes']['summarizing_fields_control'] as $l_field => $d_field)
    {
...
{
?>
   $("#sc_id_summ_available").css("min-height", "<?php echo sizeof($_SESSION['sc_session'][$sc_init]['grid_reportes']['summarizing_fields_display']) * 29 ?>px");
   $("#sc_id_summ_selected").css("min-height", "<?php echo sizeof($_SESSION['sc_session'][$sc_init]['grid_reportes']['summarizing_fields_display']) * 29 ?>px");
<?php
}
?>
  }
...
?>
 <tr id="sc_id_free_groupby">
  <td>
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['grid_reportes']['SC_Groupby_hide']))
     {
...
<?php
        ...
        foreach ($_SESSION['sc_session'][$sc_init]['grid_reportes']['SC_Gb_Free_cmp'] as $NM_cada_field => $resto)
        {
        ...
        if ($bSummaryPage)
        {
            ...
            foreach ($_SESSION['sc_session'][$sc_init]['grid_reportes']['pivot_x_axys'] as $temp)
            {
                reset($aTmpGroupBy);
...
<?php
        ...
        {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['SC_Gb_Free_cmp'][$NM_cada_field]))
           {
?>
...
<?php
        foreach ($_SESSION['sc_session'][$sc_init]['grid_reportes']['summarizing_fields_order'] as $i_sum)
        {
            if ('' != $i_sum && isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['summarizing_fields_display'][$i_sum]))
            {
                $d_sum = $_SESSION['sc_session'][$sc_init]['grid_reportes']['summarizing_fields_display'][$i_sum];
                if ($d_sum['display'])
                {
                    $sLabel = $d_sum['label'];
                    $sId    = '';
