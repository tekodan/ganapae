...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["alert_____grid_reportes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["alert_____grid_reportes"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reportes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_reportes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reportes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_reportes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_reportes']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_reportes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_reportes']['embutida_filho'] as $ind => $sc_init)
          {
