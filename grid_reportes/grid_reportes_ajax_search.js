...
Table_sv_fil[0] = "subcategoria";
Table_sv_fil[1] = "categoria";
Table_sv_fil[2] = "fecha";
Table_sv_fil[3] = "escalar";
Table_sv_fil[4] = "terminado";
Table_sv_fil[5] = "municipio";
Table_sv_fil[6] = "lugar";
...
function ajax_refresh_field(fields, parms)
{
    nmAjaxProcOn();
    $.ajax({
      type: "POST",
