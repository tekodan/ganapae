...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha";$Nm_numeric[] = "idalerta";$Nm_numeric[] = "terminado";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_subcategoria"  <?php echo $str_hide_subcategoria?>>
<?php
      $subcategoria_look = substr($this->Db->qstr($subcategoria), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT nombre, nombre  FROM subcategoria where categoria IN ($categoria_val_str) ORDER BY nombre"; 
...
?>
    ...
    <TD class="scFilterLabelEven" > <?php
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_categoria"  <?php echo $str_hide_categoria?>>
<?php
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_escalar"  <?php echo $str_hide_escalar?>> 
<?php
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_terminado"  <?php echo $str_hide_terminado?>> 
<?php
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_municipio"  <?php echo $str_hide_municipio?>>
<?php
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_lugar"  <?php echo $str_hide_lugar?>>
<?php
      $lugar_look = substr($this->Db->qstr($lugar), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT NOMBRE_SEDE_EDUCATIVA, NOMBRE_SEDE_EDUCATIVA  FROM colegios WHERE municipio='$municipio' ORDER BY NOMBRE_SEDE_EDUCATIVA"; 
