...
class grid_reportes_res_xls
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "grid_reportes.xls";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['xls_name']);
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['xls_file'] = $this->Xls_f;
      }
