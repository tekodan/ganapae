<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_reportes_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_reportes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['lugar'] = "on";
   $tab_def_campos['lugar'] = "lugar";
   $tab_converte["lugar"]   = "lugar";
   $tab_labels["lugar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']["lugar"])) ? $_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']["lugar"] : "Lugar";
   $tab_ger_campos['municipio'] = "on";
   $tab_def_campos['municipio'] = "municipio";
   $tab_converte["municipio"]   = "municipio";
   $tab_labels["municipio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']["municipio"])) ? $_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']["municipio"] : "Municipio";
   $tab_ger_campos['terminado'] = "on";
   $tab_def_campos['terminado'] = "terminado";
   $tab_converte["terminado"]   = "terminado";
   $tab_labels["terminado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']["terminado"])) ? $_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']["terminado"] : "Terminado";
   $tab_ger_campos['escalar'] = "on";
   $tab_def_campos['escalar'] = "escalar";
   $tab_converte["escalar"]   = "escalar";
   $tab_labels["escalar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']["escalar"])) ? $_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']["escalar"] : "Escalar";
   $tab_ger_campos['categoria'] = "on";
   $tab_def_campos['categoria'] = "categoria";
   $tab_converte["categoria"]   = "categoria";
   $tab_labels["categoria"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']["categoria"])) ? $_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']["categoria"] : "Categoria";
   $tab_ger_campos['subcategoria'] = "on";
   $tab_def_campos['subcategoria'] = "subcategoria";
   $tab_converte["subcategoria"]   = "subcategoria";
   $tab_labels["subcategoria"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']["subcategoria"])) ? $_SESSION['sc_session'][$sc_init]['grid_reportes']['labels']["subcategoria"] : "Subcategoria";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_reportes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_reportes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reportes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_reportes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_reportes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_reportes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_reportes']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_reportes_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_reportes']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_reportes']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
