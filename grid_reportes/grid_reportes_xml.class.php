...
class grid_reportes_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_reportes.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_reportes";
   ...
   function NM_export_lugar()
   {
         ...
         $this->xml_registro .= " lugar =\"" . $this->trata_dados($this->lugar) . "\"";
   }
   //----- municipio
   ...
   function NM_export_terminado()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->terminado))
         {
             $this->terminado = sc_convert_encoding($this->terminado, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " terminado =\"" . $this->trata_dados($this->terminado) . "\"";
   }
   //----- escalar
   function NM_export_escalar()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->escalar))
         {
             $this->escalar = sc_convert_encoding($this->escalar, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " escalar =\"" . $this->trata_dados($this->escalar) . "\"";
   }
   //----- categoria
   function NM_export_categoria()
   {
         ...
         $this->xml_registro .= " categoria =\"" . $this->trata_dados($this->categoria) . "\"";
   }
   //----- subcategoria
   function NM_export_subcategoria()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->subcategoria))
         {
             $this->subcategoria = sc_convert_encoding($this->subcategoria, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " subcategoria =\"" . $this->trata_dados($this->subcategoria) . "\"";
   }
   //----- latitud
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
