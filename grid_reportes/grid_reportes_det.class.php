...
class grid_reportes_det
{
 ...
 function monta_det()
 {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['seq_dir'] = 0; 
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['sub_dir'] = array(); 
   ...
   { 
       $nmgp_select = "SELECT subcategoria, categoria, latitud, longitud, estado, idalerta, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, str_replace (convert(char(10),fecha,102), '.', '-') + ' ' + convert(char(8),fecha,20), escalar, motivo, terminado from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql)) 
   { 
       $nmgp_select = "SELECT subcategoria, categoria, latitud, longitud, estado, idalerta, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, convert(char(23),fecha,121), escalar, motivo, terminado from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle)) 
   { 
       $nmgp_select = "SELECT subcategoria, categoria, latitud, longitud, estado, idalerta, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, fecha, escalar, motivo, terminado from " . $this->Ini->nm_tabela; 
   } 
   elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix)) 
   { 
       $nmgp_select = "SELECT subcategoria, categoria, latitud, longitud, estado, idalerta, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, EXTEND(fecha, YEAR TO DAY), escalar, motivo, terminado from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT subcategoria, categoria, latitud, longitud, estado, idalerta, geo, correo, nombre, celular, direccion, alerta, rutavideo, rutaaudio, rutaimagen, canal, radicado, origenalerta, departamento, municipio, lugar, fecha, escalar, motivo, terminado from " . $this->Ini->nm_tabela; 
   } 
   $parms_det = explode("*PDet*", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['chave_det']) ; 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cmp_acum']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cmp_acum']))
   {
       $parms_acum = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['cmp_acum']);
...
//--- 
   ...
   if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['det_print'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
   {
   ...
   else
   {
       ...
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_reportes/grid_reportes_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['pdf_det'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['det_print'] != "print")
   {
   ...
   $nm_saida->saida("  </TD>\r\n");
   $nm_saida->saida(" </TR>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['det_print'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['pdf_det']) 
   { 
       $nm_saida->saida("   <tr><td class=\"scGridTabelaTd\">\r\n");
       ...
       {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Dpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reportes/grid_reportes_config_pdf.php?nm_opc=pdf_det&nm_target=0&nm_cor=cor&papel=1&orientacao=1&largura=1200&conf_larg=S&conf_fonte=10&language=es&conf_socor=S&KeepThis=false&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
       if ($this->nmgp_botoes['det_print'] == "on")
       {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Dprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reportes/grid_reportes_config_print.php?nm_opc=detalhe&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
   ...
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          ...
          $conteudo = trim(sc_strip_script($this->subcategoria)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_subcategoria_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_subcategoria_det_line\"   ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   ...
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_categoria_det_line\"   ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
   ...
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['geo'])) ? $this->New_label['geo'] : "Geo"; 
          $conteudo = trim(sc_strip_script($this->geo)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['rutaaudio'])) ? $this->New_label['rutaaudio'] : "Rutaaudio"; 
          $conteudo = trim(sc_strip_script($this->rutaaudio)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['rutaimagen'])) ? $this->New_label['rutaimagen'] : "Rutaimagen"; 
          $conteudo = trim(sc_strip_script($this->rutaimagen)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['origenalerta'])) ? $this->New_label['origenalerta'] : "Origenalerta"; 
   ...
   $nm_saida->saida("    <TD class=\"scGridFieldEvenVert css_motivo_det_line\"   ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['terminado'])) ? $this->New_label['terminado'] : "Terminado"; 
          $conteudo = trim(NM_encode_input(sc_strip_script($this->terminado))); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("    <TD class=\"scGridLabelFont css_terminado_det_label\"  >" . nl2br($SC_Label) . "</TD>\r\n");
   $nm_saida->saida("    <TD class=\"scGridFieldOddVert css_terminado_det_line\"  NOWRAP ALIGN=\"\" VALIGN=\"\">" . $conteudo . "</TD>\r\n");
   $nm_saida->saida("   \r\n");
   $nm_saida->saida("  </TR>\r\n");
   $nm_saida->saida("</TABLE>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['det_print'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reportes']['pdf_det']) 
...
//--- 
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       NovaJanela = window.open (\"grid_reportes_doc.php?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&nm_cod_doc=\" + campo1 + \"&nm_nome_doc=\" + campo2 + \"&nm_cod_apl=\" + campo3, \"ScriptCase\", \"resizable\");\r\n");
   $nm_saida->saida("   }\r\n");
   $nm_saida->saida("   function nm_gp_move(x, y, z, p, g) \r\n");
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "grid_reportes/index.php?nmgp_opcao=pdf_det&nmgp_tipo_pdf=\" + z + \"&nmgp_parms_pdf=\" + p +  \"&nmgp_graf_pdf=\" + g + \"&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "\";\r\n");
   $nm_saida->saida("   }\r\n");
   $nm_saida->saida("   function nm_gp_print_conf(tp, cor)\r\n");
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grid_reportes/grid_reportes_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=det_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
   $nm_saida->saida("   }\r\n");
