...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["alert_____alerta"]))
   {
      unset($_SESSION['session_sec_aplicacao']["alert_____alerta"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']['alerta']))
   {
       unset($_SESSION['scriptcase']['sc_aba_iframe']['alerta']);
   }
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['alerta']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['alerta']['sc_outra_jan'])
   {
       $fecha_janela = true;
   }
   $fecha_modal = false;
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['alerta']['aba_saida']) && $_SESSION['sc_session'][$script_case_init]['alerta']['aba_saida'] == "modal")
   {
       unset($_SESSION['sc_session'][$script_case_init]['alerta']['aba_saida']);
       $fecha_modal = true;
   }
