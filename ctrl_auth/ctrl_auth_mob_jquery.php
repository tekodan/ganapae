...
function scEventControl_init(iSeqRow) {
  scEventControl_data["tip" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": ""};
...
function scEventControl_active(iSeqRow) {
  if (scEventControl_data["tip" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["tip" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["photo" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["photo" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_tip' + iSeqRow).bind('blur', function() { sc_ctrl_auth_tip_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_ctrl_auth_tip_onfocus(this, iSeqRow) });
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_ctrl_auth_id_onblur(this, iSeqRow) })
                                .bind('focus', function() { sc_ctrl_auth_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_photo' + iSeqRow).bind('blur', function() { sc_ctrl_auth_photo_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_ctrl_auth_photo_onfocus(this, iSeqRow) });
  $('#id_sc_field_name' + iSeqRow).bind('blur', function() { sc_ctrl_auth_name_onblur(this, iSeqRow) })
