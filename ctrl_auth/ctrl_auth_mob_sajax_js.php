  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_ctrl_auth_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate tip
  function do_ajax_ctrl_auth_mob_validate_tip()
  {
  } // do_ajax_ctrl_auth_mob_validate_tip

  function do_ajax_ctrl_auth_mob_validate_tip_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ctrl_auth_mob_validate_tip_cb

  // ---------- Validate photo
  function do_ajax_ctrl_auth_mob_validate_photo()
  {
  } // do_ajax_ctrl_auth_mob_validate_photo

  function do_ajax_ctrl_auth_mob_validate_photo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "photo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ctrl_auth_mob_validate_photo_cb

  // ---------- Validate id
  function do_ajax_ctrl_auth_mob_validate_id()
  {
  } // do_ajax_ctrl_auth_mob_validate_id

  function do_ajax_ctrl_auth_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ctrl_auth_mob_validate_id_cb

  // ---------- Validate name
  function do_ajax_ctrl_auth_mob_validate_name()
  {
  } // do_ajax_ctrl_auth_mob_validate_name

  function do_ajax_ctrl_auth_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "name";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ctrl_auth_mob_validate_name_cb
  // ---------- Form
  function do_ajax_ctrl_auth_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_ctrl_auth_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_ctrl_auth_mob_submit_form(var_tip, var_photo, var_id, var_name, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_ctrl_auth_mob_submit_form_cb);
  } // do_ajax_ctrl_auth_mob_submit_form

  function do_ajax_ctrl_auth_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_ctrl_auth_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_ctrl_auth_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_ctrl_auth_mob_navigate_form

  function do_ajax_ctrl_auth_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_ctrl_auth_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_ctrl_auth_mob_navigate_form_cb
  function sc_hide_ctrl_auth_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_ctrl_auth_mob_form
  ...
  var ajax_error_list = {
    "tip": {"label": "<?php echo $this->Ini->Nm_lang['lang_auth_tip'] ?>:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "name": {"label": "<?php echo $this->Ini->Nm_lang['lang_name'] ?>:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
